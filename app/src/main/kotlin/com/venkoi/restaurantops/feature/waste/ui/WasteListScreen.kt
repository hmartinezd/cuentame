...
import com.venkoi.restaurantops.feature.waste.viewmodel.WasteListUiState
import com.venkoi.restaurantops.feature.waste.viewmodel.WasteListViewModel
    ...
    Scaffold(
        ...
        topBar = {
            TopAppBar(
                ...
                navigationIcon = {
                    IconButton(onClick = onBack, modifier = Modifier.testTag("waste_list_back")) {
