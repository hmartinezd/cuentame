...
import com.venkoi.cuentame.core.database.backup.BackupSnapshot
...
fun MenuPublicationItemBackupDto.toEntity()=MenuPublicationItemEntity(id,publicationId,publicationCategoryId,sourceMenuPlacementId,menuRecipeId,displayNameSnapshot,java.math.BigDecimal(sellingPriceSnapshot),com.venkoi.cuentame.core.model.menu.CashDiscountBehavior.valueOf(cashDiscountBehaviorSnapshot),commercialRevision,consumptionRevision,sortOrder)
...
fun MenuRecipeBackupDto.toEntity() = MenuRecipeEntity(
    ...
    notes = notes,
    cashDiscountBehavior = com.venkoi.cuentame.core.model.menu.CashDiscountBehavior.valueOf(cashDiscountBehavior),
    commercialRevision = commercialRevision,
    consumptionRevision = consumptionRevision,
    archivedAt = archivedAt,
    createdAt = createdAt,
