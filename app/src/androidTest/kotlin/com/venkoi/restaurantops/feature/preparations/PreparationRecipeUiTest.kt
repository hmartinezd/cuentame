...
class PreparationRecipeUiTest {
    ...
    fun create_recipe_e2e_flow() {
        ActivityScenario.launch(MainActivity::class.java).use {
            ...
            assertEquals(com.venkoi.restaurantops.core.model.ingredient.PreparationRecipeStatus.DRAFT.name, recipe!!.status)
        ...
        ActivityScenario.launch(MainActivity::class.java).use {
            ...
            runBlocking {
                database.preparationRecipeDao().insert(PreparationRecipeEntity(
                    ...
                    status = com.venkoi.restaurantops.core.model.ingredient.PreparationRecipeStatus.ACTIVE.name,
