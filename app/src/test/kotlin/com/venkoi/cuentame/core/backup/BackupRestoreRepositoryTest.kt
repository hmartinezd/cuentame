...
import com.venkoi.cuentame.core.backup.fakes.FakeBackupDocumentStore
import com.venkoi.cuentame.core.backup.platform.AndroidBackupRestoreRepository
...
class BackupRestoreRepositoryTest {
    ...
    fun `inspect successfully returns ready result and closes stream`() = runTest {
        val ready = BackupArchiveInspectionResult.Ready(mockk(), mockk(), com.venkoi.cuentame.core.model.backup.BackupRestoreEligibility.Eligible)
