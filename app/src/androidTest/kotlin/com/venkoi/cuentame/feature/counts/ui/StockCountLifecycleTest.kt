...
class StockCountLifecycleTest {
    ...
    @Inject
    lateinit var attachmentPermissionManager: com.venkoi.cuentame.core.common.attachment.LocalAttachmentPermissionManager
    ...
    fun setup() {
        hiltRule.inject()
        (failureBoundary as? com.venkoi.cuentame.core.database.repository.ConfigurableFailureBoundary)?.reset()
