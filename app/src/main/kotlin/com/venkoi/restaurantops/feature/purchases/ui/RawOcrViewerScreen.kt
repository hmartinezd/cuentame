...
import com.venkoi.restaurantops.feature.purchases.viewmodel.RawOcrViewerUiState
import com.venkoi.restaurantops.feature.purchases.viewmodel.RawOcrViewerViewModel
...
@Composable
private fun OcrHeader(result: com.venkoi.restaurantops.core.model.purchase.ocr.PurchaseInvoiceOcrResult) {
    Card(
