...
import com.venkoi.restaurantops.core.backup.internal.RoomRestoreDatabaseApplier
import dagger.Binds
...
interface BackupModule {
    ...
    @Binds
    @Singleton
    fun bindRestoreDatabaseApplier(impl: RoomRestoreDatabaseApplier): com.venkoi.restaurantops.core.backup.internal.RestoreDatabaseApplier
