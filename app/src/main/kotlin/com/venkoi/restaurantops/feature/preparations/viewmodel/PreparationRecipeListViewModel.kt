...
import com.venkoi.restaurantops.core.model.ingredient.PreparationRecipeSummary
...
data class PreparationRecipeListUiState(
    ...
    val costs: Map<com.venkoi.restaurantops.core.common.ids.PreparationRecipeId, PreparationRecipeCostSummary> = emptyMap(),
    val error: Throwable? = null
)

sealed interface RecipeListLoadResult {
    data object Loading : RecipeListLoadResult
    data class Success(val recipes: List<PreparationRecipeSummary>, val costs: Map<com.venkoi.restaurantops.core.common.ids.PreparationRecipeId, PreparationRecipeCostSummary>) : RecipeListLoadResult
...
private object EmptyListPreparationCostRepository : PreparationCostRepository {
    override fun observeRecipeCost(recipeId: com.venkoi.restaurantops.core.common.ids.PreparationRecipeId) = flowOf(null)
    override fun observeRecipeCostSummaries(restaurantId: com.venkoi.restaurantops.core.common.ids.RestaurantId) = flowOf(emptyList<PreparationRecipeCostSummary>())
}
