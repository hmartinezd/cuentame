...
import com.venkoi.restaurantops.core.domain.repository.ProductionBatchPostingPreview
...
import com.venkoi.restaurantops.feature.production.presentation.toUserMessage
...
class ProductionBatchPostingPreviewViewModel @Inject constructor(
    ...
    private val ingredientRepository: com.venkoi.restaurantops.core.domain.repository.IngredientRepository,
    ...
    fun onPost() {
        ...
        viewModelScope.launch {
            try {
                ...
                throw e
            } catch (e: com.venkoi.restaurantops.core.domain.validation.ProductionBatchValidationException) {
