package com.venkoi.cuentame.core.database
...
import com.venkoi.cuentame.core.ocr.parser.ParsedField
import com.venkoi.cuentame.core.ocr.parser.Correction
...
class RoomPurchaseInvoiceCorrectnessTest {
    ...
    @Inject
    lateinit var failureBoundary: com.venkoi.cuentame.core.database.repository.ConfigurableFailureBoundary
    ...
    fun materialization_propagatesCancellationInsteadOfPersistenceFailure() = runBlocking {
        ...
        failureBoundary.triggerOn(
            com.venkoi.cuentame.core.database.repository.IntegrationFailurePoints.PURCHASE_MATERIALIZATION_AFTER_START,
    ...
    fun sourceLocking_preventsMutationAfterMaterialization() = runBlocking {
        ...
        val resultUpdateParse = repository.updateParseResult(receiptId, com.venkoi.cuentame.core.ocr.parser.PurchaseInvoiceCorrections())
    ...
    private suspend fun seedPurchaseWithParseResult(lineCount: Int = 1): PurchaseReceiptId {
        ...
        val storedDoc = com.venkoi.cuentame.test.TestDocumentFixture.storeTestDocument(context, documentStore, receiptId)
        val sha = com.venkoi.cuentame.test.TestDocumentFixture.calculateSha256(documentStore.getFile(storedDoc.location))
