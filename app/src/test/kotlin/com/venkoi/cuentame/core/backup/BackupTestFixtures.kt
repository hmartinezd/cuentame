...
import com.venkoi.cuentame.core.model.backup.BackupAttachmentMetadata
import com.venkoi.cuentame.core.model.backup.BackupAttachmentReference
...
object BackupTestFixtures {
    ...
    fun createValidAttachmentArchiveFixture(
        jsonCodecs: com.venkoi.cuentame.core.backup.api.BackupJsonCodecs
        ...
        val manifest = BackupManifest(
            ...
            tableMetadata = mapOf(
                ...
                "menu_publications" to TableMetadata(snapshotWithAttachment.menuPublications.size, false),
                "menu_publication_categories" to TableMetadata(snapshotWithAttachment.menuPublicationCategories.size, false),
                "menu_publication_items" to TableMetadata(snapshotWithAttachment.menuPublicationItems.size, false),
                "menu_publication_item_components" to TableMetadata(snapshotWithAttachment.menuPublicationItemComponents.size, false),
                "sales_imports" to TableMetadata(snapshotWithAttachment.salesImports.size, false),
                "imported_sale_transactions" to TableMetadata(snapshotWithAttachment.importedSaleTransactions.size, false),
                "imported_sale_lines" to TableMetadata(snapshotWithAttachment.importedSaleLines.size, false),
                "sales_import_transaction_refs" to TableMetadata(snapshotWithAttachment.salesImportTransactionRefs.size, false),
