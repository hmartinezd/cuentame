...
class AndroidBackupRepositoryTest {
    ...
    fun createBackup_successful_sequence() = runTest {
        ...
        val rest = mockk<Restaurant>(relaxed = true) {
            io.mockk.every { id } returns com.venkoi.restaurantops.core.common.ids.RestaurantId("r1")
        }
        ...
        coEvery { archiveValidator.validate(any()) } returns com.venkoi.restaurantops.core.model.backup.BackupValidationResult.Valid(manifest)
