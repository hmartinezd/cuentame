...
class CsvImportServiceTest {
    ...
    fun setup() {
        ...
        val lb = UnitOfMeasure(com.venkoi.restaurantops.core.common.ids.UnitId("mass_lb"), "Pound", "lb", UnitDimension.MASS, BigDecimal.ONE, true, 0)
    ...
    fun `stable system unit ids resolve supported import aliases`() = runTest {
        val units = listOf(
            UnitOfMeasure(com.venkoi.restaurantops.core.common.ids.UnitId("mass_lb"), "Pound", "lb", UnitDimension.MASS, BigDecimal.ONE, true, 0),
            UnitOfMeasure(com.venkoi.restaurantops.core.common.ids.UnitId("mass_oz"), "Ounce", "oz", UnitDimension.MASS, BigDecimal.ONE, true, 1),
            UnitOfMeasure(com.venkoi.restaurantops.core.common.ids.UnitId("mass_kg"), "Kilogram", "kg", UnitDimension.MASS, BigDecimal.ONE, true, 2),
            UnitOfMeasure(com.venkoi.restaurantops.core.common.ids.UnitId("volume_ml"), "Milliliter", "ml", UnitDimension.VOLUME, BigDecimal.ONE, true, 3),
            UnitOfMeasure(com.venkoi.restaurantops.core.common.ids.UnitId("volume_gallon_us"), "US Gallon", "gal", UnitDimension.VOLUME, BigDecimal.ONE, true, 4),
            UnitOfMeasure(com.venkoi.restaurantops.core.common.ids.UnitId("count_each"), "Each", "ea", UnitDimension.COUNT, BigDecimal.ONE, true, 5)
        )
    ...
    fun `incompatible count unit issue uses unit symbols`() = runTest {
        val each = UnitOfMeasure(
            id = com.venkoi.restaurantops.core.common.ids.UnitId("each"), name = "Each", symbol = "ea",
            dimension = UnitDimension.COUNT, factorToCanonical = BigDecimal.ONE, isSystem = true, sortOrder = 1
        )
        val lb = UnitOfMeasure(
            id = com.venkoi.restaurantops.core.common.ids.UnitId("lb"), name = "Pound", symbol = "lb",
    ...
    fun `detect archived category conflict error`() = runTest {
        val archivedCategory = com.venkoi.restaurantops.core.model.ingredient.IngredientCategory(
            id = com.venkoi.restaurantops.core.common.ids.IngredientCategoryId("cat-1"),
    ...
    private fun category(id: String, deletedAt: Instant? = null) =
        com.venkoi.restaurantops.core.model.ingredient.IngredientCategory(
            com.venkoi.restaurantops.core.common.ids.IngredientCategoryId(id), restaurantId, "Produce", "produce", 0,
            true, Instant.EPOCH, Instant.EPOCH, deletedAt
        )

    private fun supplier(id: String, deletedAt: Instant? = null) =
        com.venkoi.restaurantops.core.model.supplier.Supplier(
            com.venkoi.restaurantops.core.common.ids.SupplierId(id), restaurantId, "Sysco", "sysco",
