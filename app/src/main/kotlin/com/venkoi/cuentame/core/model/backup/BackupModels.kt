...
data class RestoreDatabaseRollbackSnapshot(
    val snapshot: com.venkoi.cuentame.core.backup.model.BackupSnapshotDto,
    ...
    val attachmentInventory: List<com.venkoi.cuentame.core.backup.internal.RollbackAttachmentMetadata> = emptyList()
)
