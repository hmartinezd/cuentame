...
import com.venkoi.restaurantops.feature.activity.viewmodel.InventoryActivityDetailScreenState
...
private fun InventoryActivityDetailContent(
    ...
    Column(
        ...
        if (item.movement.movementType == com.venkoi.restaurantops.core.model.inventory.InventoryMovementType.REVERSAL) {
...
private fun RelatedMovementSection(
    label: String,
    display: com.venkoi.restaurantops.core.model.inventory.InventoryActivityRelatedMovementDisplay?,
...
private fun RelatedMovementCard(
    title: String,
    related: com.venkoi.restaurantops.core.model.inventory.InventoryActivityRelatedMovementDisplay,
    onClick: () -> Unit,
    testTag: String,
    locale: java.util.Locale
) {
