...
class InventoryIsolationTest {
    ...
    @Inject
    lateinit var database: com.venkoi.restaurantops.core.database.RestaurantInventoryDatabase
    ...
    fun recipeOperationsLeaveInventoryUntouched() = runBlocking {
        ...
        database.restaurantDao().insert(com.venkoi.restaurantops.core.database.entity.RestaurantEntity(restaurantId.value, "R", "USD", "en-US", 0L, 0L, null))
        database.unitDao().insertSeedUnits(listOf(com.venkoi.restaurantops.core.database.entity.UnitEntity("u1", "U", "u", "MASS", BigDecimal.ONE, true, 0)))
        ...
        database.ingredientDao().insert(com.venkoi.restaurantops.core.database.entity.IngredientEntity(outputId.value, restaurantId.value, "Output", "output", null, "u1", null, null, null, null, true, 0, 0, null))
        database.ingredientDao().insert(com.venkoi.restaurantops.core.database.entity.IngredientEntity(compId.value, restaurantId.value, "Comp", "comp", null, "u1", null, null, null, null, true, 0, 0, null))
        database.ingredientUnitOptionDao().insert(com.venkoi.restaurantops.core.database.entity.IngredientUnitOptionEntity(yieldUnitId.value, outputId.value, "Unit", "unit", null, BigDecimal.ONE, true, true, true, true, 0, 0, null))
        database.ingredientUnitOptionDao().insert(com.venkoi.restaurantops.core.database.entity.IngredientUnitOptionEntity(compUnitId.value, compId.value, "Unit", "unit", null, BigDecimal.ONE, true, true, true, true, 0, 0, null))
