...
import com.venkoi.restaurantops.core.backup.BackupSnapshotIntegrityException
import com.venkoi.restaurantops.core.backup.BackupSnapshotIntegrityValidator
import com.venkoi.restaurantops.core.backup.ChecksumParser
...
import com.venkoi.restaurantops.core.backup.internal.BackupArchiveProcessingResult
...
class DefaultBackupArchiveReader @Inject constructor(
    ...
    override suspend fun inspect(
        ...
        val eligibility = com.venkoi.restaurantops.core.model.backup.BackupRestoreEligibility.Eligible
