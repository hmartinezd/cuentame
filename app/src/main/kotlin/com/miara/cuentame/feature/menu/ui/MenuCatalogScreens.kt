...
@OptIn(ExperimentalMaterial3Api::class)
@Composable fun MenuCatalogDetailRoute(onBack:()->Unit,onOpenMenuItem:(MenuRecipeId)->Unit,onCreateMenuItem:(com.miara.cuentame.core.common.ids.MenuId,com.miara.cuentame.core.common.ids.MenuCategoryId)->Unit,vm:MenuCatalogDetailViewModel=hiltViewModel()){
