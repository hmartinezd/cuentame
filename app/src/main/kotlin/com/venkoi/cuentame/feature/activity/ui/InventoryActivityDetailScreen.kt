...
import com.venkoi.cuentame.feature.activity.viewmodel.InventoryActivityDetailScreenState
import com.venkoi.cuentame.feature.activity.viewmodel.InventoryActivityDetailViewModel
...
private fun InventoryActivityDetailContent(
    ...
    Column(
        ...
        if (item.movement.movementType == com.venkoi.cuentame.core.model.inventory.InventoryMovementType.REVERSAL) {
...
private fun RelatedMovementSection(
    label: String,
    display: com.venkoi.cuentame.core.model.inventory.InventoryActivityRelatedMovementDisplay?,
...
private fun RelatedMovementCard(
    title: String,
    related: com.venkoi.cuentame.core.model.inventory.InventoryActivityRelatedMovementDisplay,
    onClick: () -> Unit,
    testTag: String,
    locale: java.util.Locale
) {
