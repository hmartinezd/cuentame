        ...
        viewModelScope.launch {
            retryTrigger.collectLatest {
                ...
                try {
                    ...
                    if (restaurant == null) {
                        _uiState.update { it.copy(screenState = ProductionBatchScreenState.LoadError(com.miara.cuentame.core.presentation.ui.UiMessage.Resource(com.miara.cuentame.R.string.error_no_restaurant))) }
                    ...
                    _uiState.update {
                        it.copy(
                            screenState = ProductionBatchScreenState.LoadError(com.miara.cuentame.core.presentation.ui.UiMessage.Resource(com.miara.cuentame.R.string.error_generic))
                        )
                    }
                }
            }
