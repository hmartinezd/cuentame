...
import com.venkoi.restaurantops.feature.ingredients.csvimport.domain.CsvTemplateGenerator
...
import com.venkoi.restaurantops.feature.ingredients.csvimport.domain.CsvSourceColumn
import com.venkoi.restaurantops.feature.ingredients.csvimport.domain.CsvSourceTable
...
class CsvImportViewModelTest {
    ...
    fun `valid alias mapping creates preview`() = runTest {
        val restaurant = mockk<com.venkoi.restaurantops.core.model.restaurant.Restaurant>()
        val restaurantId = com.venkoi.restaurantops.core.common.ids.RestaurantId("rest-1")
    ...
    fun `confirmImport single-flight guard`() = runTest {
        val restaurant = mockk<com.venkoi.restaurantops.core.model.restaurant.Restaurant>()
        every { restaurant.id } returns com.venkoi.restaurantops.core.common.ids.RestaurantId("rest-1")
        coEvery { restaurantRepository.getRestaurant() } returns restaurant
