...
import com.venkoi.restaurantops.core.database.model.TopWasteRow
import com.venkoi.restaurantops.core.database.model.WasteValueRow
import com.venkoi.restaurantops.core.database.model.RecentWasteActivityRow
...
interface InventoryMovementDao {
    ...
    fun observeInventoryActivityRows(
        ...
        areaId: String? = null
    ): Flow<List<com.venkoi.restaurantops.core.database.model.InventoryActivityRow>>
    ...
    """)
    suspend fun getInventoryActivityRow(restaurantId: String, movementId: String): com.venkoi.restaurantops.core.database.model.InventoryActivityRow?
}
