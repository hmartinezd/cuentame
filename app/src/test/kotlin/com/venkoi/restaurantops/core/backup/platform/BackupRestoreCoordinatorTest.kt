...
class BackupRestoreCoordinatorTest {
    ...
    private val operationGate = com.venkoi.restaurantops.core.backup.internal.RestoreOperationGate()
    ...
    private fun createEmptySnapshot() = com.venkoi.restaurantops.core.backup.model.BackupSnapshotDto(
