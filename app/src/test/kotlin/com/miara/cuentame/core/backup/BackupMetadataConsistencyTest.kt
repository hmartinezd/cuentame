...
class BackupMetadataConsistencyTest {
    ...
    private fun createManifestForSnapshot(
        ...
        val tableMetadata = mutableMapOf<String, com.miara.cuentame.core.model.backup.TableMetadata>()
        ...
        for (table in expectedTables) {
            ...
            tableMetadata[table] = com.miara.cuentame.core.model.backup.TableMetadata(
                entryCount = count,
