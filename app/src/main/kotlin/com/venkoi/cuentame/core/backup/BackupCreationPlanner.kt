...
class BackupCreationPlanner @Inject constructor(
    ...
    suspend fun createPlan(
        ...
        try {
            ...
            BackupSnapshotIntegrityValidator.validate(snapshotDto, finalManifest).getOrElse { e ->
                if (e is com.venkoi.cuentame.core.backup.BackupSnapshotIntegrityException) {
                } else {
                }
    ...
    private fun createTableMetadata(dto: com.venkoi.cuentame.core.backup.model.BackupSnapshotDto): Map<String, TableMetadata> {
