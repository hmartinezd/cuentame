...
import com.venkoi.restaurantops.feature.ingredients.viewmodel.IngredientFormEvent
import com.venkoi.restaurantops.feature.ingredients.viewmodel.IngredientFormViewModel
...
fun IngredientFormScreen(
    ...
    onDefaultAreaSelected: (com.venkoi.restaurantops.core.common.ids.InventoryAreaId?) -> Unit,
    ...
    onSave: () -> Unit,
    getStandardPreview: (UnitOfMeasure) -> com.venkoi.restaurantops.feature.ingredients.model.UnitConversionChoiceUiModel?,
    onBack: () -> Unit
) {
...
private fun DefaultAreaSelector(
    areas: List<InventoryArea>,
    selected: com.venkoi.restaurantops.core.common.ids.InventoryAreaId?,
    onSelected: (com.venkoi.restaurantops.core.common.ids.InventoryAreaId?) -> Unit
) {
