...
class MenuCatalogDetailViewModelTest {
    ...
    private fun viewModel() = MenuCatalogDetailViewModel(SavedStateHandle(mapOf("menuId" to menuId.value)), catalogs, recipes, restaurants, publications, com.venkoi.restaurantops.core.domain.service.MenuPackageExporter(publications))
