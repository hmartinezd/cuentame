...
import com.venkoi.cuentame.core.backup.BackupSnapshotIntegrityCode.*
...
import com.venkoi.cuentame.core.domain.service.HistoricalInventoryCostBoundary
import com.venkoi.cuentame.core.domain.service.HistoricalInventoryMovement
import com.venkoi.cuentame.core.domain.service.SourceDocumentIdentity
import com.venkoi.cuentame.core.domain.service.HistoricalInventoryCostResult
...
object BackupSnapshotIntegrityValidator {
    ...
    private fun validateSalesImports(dto: BackupSnapshotDto, restaurantId: String): BackupSnapshotIntegrityException? {
        ...
        fun publicationMatches(publication: com.venkoi.cuentame.core.backup.model.MenuPublicationBackupDto, ownerRestaurantId: String, menuId: String, revision: Long, currency: String) =
        ...
        for (transaction in dto.importedSaleTransactions) {
            ...
            fun importMatches(value: com.venkoi.cuentame.core.backup.model.SalesImportBackupDto) =
    ...
    private fun validateProductionOriginalMovements(
        batch: com.venkoi.cuentame.core.backup.model.ProductionBatchBackupDto,
        components: List<com.venkoi.cuentame.core.backup.model.ProductionBatchComponentBackupDto>,
        originalMovements: List<com.venkoi.cuentame.core.backup.model.InventoryMovementBackupDto>
    ): BackupSnapshotIntegrityException? {
    ...
    private fun validateProductionReversals(
        batch: com.venkoi.cuentame.core.backup.model.ProductionBatchBackupDto,
        originalMovements: List<com.venkoi.cuentame.core.backup.model.InventoryMovementBackupDto>,
        reversals: List<com.venkoi.cuentame.core.backup.model.InventoryMovementBackupDto>
    ): BackupSnapshotIntegrityException? {
    ...
    private fun validateStagedMatches(
        ...
        for (match in dto.purchaseInvoiceLineMatches) {
            ...
            // Status invariants
            val status = try {
                com.venkoi.cuentame.core.model.purchase.InvoiceLineMatchStatus.valueOf(match.status)
            } catch (_: Exception) {
    ...
    private fun validateMenuRecipes(dto: BackupSnapshotDto, ctx: ValidationContext): BackupSnapshotIntegrityException? {
        for (recipe in dto.menuRecipes) {
            ...
            if (runCatching { com.venkoi.cuentame.core.model.menu.CashDiscountBehavior.valueOf(recipe.cashDiscountBehavior) }.isFailure) return err(INVALID_MENU_STRUCTURE, "Invalid cash discount behavior")
            // Timestamps
