...
interface MenuRecipeDao {
    ...
    @Query("DELETE FROM menu_recipe_components WHERE id=:componentId AND menuRecipeId=:recipeId") suspend fun deleteComponent(recipeId: String, componentId: String): Int
