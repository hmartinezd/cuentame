package com.venkoi.restaurantops.feature.categories.ui
...
import com.venkoi.restaurantops.feature.categories.viewmodel.CategoryManagementEvent
import com.venkoi.restaurantops.feature.categories.viewmodel.CategoryManagementViewModel
...
fun CategoryManagementRoute(
    ...
    var categoryToArchive by remember { mutableStateOf<com.venkoi.restaurantops.core.model.ingredient.IngredientCategory?>(null) }
    var categoryToEdit by remember { mutableStateOf<com.venkoi.restaurantops.core.model.ingredient.IngredientCategory?>(null) }
...
fun CategoryManagementScreen(
    uiState: com.venkoi.restaurantops.feature.categories.viewmodel.CategoryManagementUiState,
    categoryToArchive: com.venkoi.restaurantops.core.model.ingredient.IngredientCategory?,
    categoryToEdit: com.venkoi.restaurantops.core.model.ingredient.IngredientCategory?,
    newCategoryName: String,
    snackbarHostState: SnackbarHostState,
    onNewCategoryNameChange: (String) -> Unit,
    onSetCategoryToArchive: (com.venkoi.restaurantops.core.model.ingredient.IngredientCategory?) -> Unit,
    onSetCategoryToEdit: (com.venkoi.restaurantops.core.model.ingredient.IngredientCategory?) -> Unit,
    onAddCategory: (String) -> Unit,
    onUpdateCategory: (com.venkoi.restaurantops.core.model.ingredient.IngredientCategory) -> Unit,
    onArchiveCategory: (com.venkoi.restaurantops.core.model.ingredient.IngredientCategory) -> Unit,
    onMoveUp: (Int) -> Unit,
    onMoveDown: (Int) -> Unit
) {
    Scaffold(
...
@Composable
fun CategoryItem(
    category: com.venkoi.restaurantops.core.model.ingredient.IngredientCategory,
    canMoveUp: Boolean,
    canMoveDown: Boolean,
    isEnabled: Boolean,
    onMoveUp: () -> Unit,
