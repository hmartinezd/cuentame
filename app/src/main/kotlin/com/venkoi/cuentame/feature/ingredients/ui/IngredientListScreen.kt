...
import com.venkoi.cuentame.feature.ingredients.viewmodel.IngredientCategoryFilter
import com.venkoi.cuentame.feature.ingredients.viewmodel.IngredientListUiState
import com.venkoi.cuentame.feature.ingredients.viewmodel.IngredientListViewModel
        ...
        Column(
            ...
            if (uiState.isLoading) {
                ...
                Column(modifier = Modifier.fillMaxSize().padding(24.dp), horizontalAlignment = Alignment.CenterHorizontally) {
                    ...
                    if (result is com.venkoi.cuentame.core.domain.service.StarterCatalogSeedResult.Success) {
                    ...
                    } else if (result is com.venkoi.cuentame.core.domain.service.StarterCatalogSeedResult.Failure) {
