...
import com.miara.cuentame.core.domain.repository.MenuRecipeValidationException
import com.miara.cuentame.core.domain.repository.NewMenuItem
import com.miara.cuentame.core.domain.repository.NewMenuItemComponent
...
class RoomMenuItemCreationRepositoryTest {
    ...
    private fun request(menuId: String, categoryId: String, name: String) = NewMenuItem(
        menuId = com.miara.cuentame.core.common.ids.MenuId(menuId),
        categoryId = com.miara.cuentame.core.common.ids.MenuCategoryId(categoryId),
        name = name,
