...
class BackupMetadataParityTest {
    ...
    private fun createExpectedMetadata(dto: BackupSnapshotDto): Map<String, TableMetadata> {
        ...
        val counts = mapOf(
            ...
            "menus" to dto.menus.size,
            "menu_categories" to dto.menuCategories.size,
            "menu_placements" to dto.menuPlacements.size,
            "menu_publications" to dto.menuPublications.size,
            "menu_publication_categories" to dto.menuPublicationCategories.size,
            "menu_publication_items" to dto.menuPublicationItems.size,
            "menu_publication_item_components" to dto.menuPublicationItemComponents.size,
