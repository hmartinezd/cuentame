...
import com.venkoi.restaurantops.core.ocr.parser.Correction
...
class RoomPurchaseInvoiceCorrectnessTest {
    ...
    @Inject
    lateinit var failureBoundary: com.venkoi.restaurantops.core.database.repository.ConfigurableFailureBoundary
    ...
    fun materialization_propagatesCancellationInsteadOfPersistenceFailure() = runBlocking {
        ...
        failureBoundary.triggerOn(
            com.venkoi.restaurantops.core.database.repository.IntegrationFailurePoints.PURCHASE_MATERIALIZATION_AFTER_START,
    ...
    fun sourceLocking_preventsMutationAfterMaterialization() = runBlocking {
        ...
        val resultUpdateParse = repository.updateParseResult(receiptId, com.venkoi.restaurantops.core.ocr.parser.PurchaseInvoiceCorrections())
