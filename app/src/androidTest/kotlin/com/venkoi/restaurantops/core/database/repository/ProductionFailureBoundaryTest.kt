...
class ProductionFailureBoundaryTest {
    ...
    private suspend fun testPostFailure(point: String) {
        ...
        assertThat(snapshotBefore.batch.status).isEqualTo(com.venkoi.restaurantops.core.model.inventory.DocumentStatus.DRAFT)
        ...
        assertThat(snapshotAfter.batch.status).isEqualTo(com.venkoi.restaurantops.core.model.inventory.DocumentStatus.DRAFT)
    ...
    private suspend fun testVoidFailure(point: String) {
        ...
        val snapshotBefore = captureProductionSnapshot(batchId)
        assertThat(snapshotBefore.batch.status).isEqualTo(com.venkoi.restaurantops.core.model.inventory.DocumentStatus.POSTED)
        ...
        assertThat(snapshotAfter.batch.status).isEqualTo(com.venkoi.restaurantops.core.model.inventory.DocumentStatus.POSTED)
    ...
    private data class ProductionSnapshot(
        val batch: com.venkoi.restaurantops.core.model.inventory.ProductionBatch,
        val components: List<com.venkoi.restaurantops.core.model.inventory.ProductionBatchComponent>,
        val movements: List<com.venkoi.restaurantops.core.database.entity.InventoryMovementEntity>,
        val compBalance: com.venkoi.restaurantops.core.database.entity.InventoryBalanceProjectionEntity?,
        val compCost: com.venkoi.restaurantops.core.database.entity.IngredientCostProjectionEntity?,
        val outBalance: com.venkoi.restaurantops.core.database.entity.InventoryBalanceProjectionEntity?,
        val outCost: com.venkoi.restaurantops.core.database.entity.IngredientCostProjectionEntity?
    )
