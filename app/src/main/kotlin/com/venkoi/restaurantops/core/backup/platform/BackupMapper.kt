...
import com.venkoi.restaurantops.core.common.decimal.toCanonicalDecimalString
...
internal fun MenuPublicationItemComponentEntity.toDto()=MenuPublicationItemComponentBackupDto(id,publicationItemId,sourceMenuRecipeComponentId,ingredientId,ingredientUnitOptionId,inventoryAreaIdSnapshot,quantityEnteredSnapshot.toNormalizedString(),quantityBaseSnapshot.toNormalizedString(),sortOrder)
...
fun MenuPublicationItemBackupDto.toEntity()=MenuPublicationItemEntity(id,publicationId,publicationCategoryId,sourceMenuPlacementId,menuRecipeId,displayNameSnapshot,java.math.BigDecimal(sellingPriceSnapshot),com.venkoi.restaurantops.core.model.menu.CashDiscountBehavior.valueOf(cashDiscountBehaviorSnapshot),commercialRevision,consumptionRevision,sortOrder)
fun MenuPublicationItemComponentBackupDto.toEntity()=MenuPublicationItemComponentEntity(id,publicationItemId,sourceMenuRecipeComponentId,ingredientId,ingredientUnitOptionId,inventoryAreaIdSnapshot,java.math.BigDecimal(quantityEnteredSnapshot),java.math.BigDecimal(quantityBaseSnapshot),sortOrder)
...
fun MenuRecipeBackupDto.toEntity() = MenuRecipeEntity(
    ...
    notes = notes,
    cashDiscountBehavior = com.venkoi.restaurantops.core.model.menu.CashDiscountBehavior.valueOf(cashDiscountBehavior),
    commercialRevision = commercialRevision,
    consumptionRevision = consumptionRevision,
    archivedAt = archivedAt,
    createdAt = createdAt,
