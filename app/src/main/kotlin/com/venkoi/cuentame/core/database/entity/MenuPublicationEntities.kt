...
data class MenuPublicationItemComponentEntity(@PrimaryKey val id:String,val publicationItemId:String,val sourceMenuRecipeComponentId:String,val ingredientId:String,val ingredientUnitOptionId:String,val inventoryAreaIdSnapshot:String,val quantityEnteredSnapshot:BigDecimal,val quantityBaseSnapshot:BigDecimal,val sortOrder:Int)
