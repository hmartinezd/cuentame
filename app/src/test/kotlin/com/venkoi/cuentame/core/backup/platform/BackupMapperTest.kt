...
import com.venkoi.cuentame.core.backup.model.PurchaseLineBackupDto
...
class BackupMapperTest {
    ...
    fun `Audit all mappers for round-trip consistency`() {
        ...
        val ingDto = com.venkoi.cuentame.core.backup.model.IngredientBackupDto(
            id = "i1",
            restaurantId = "r1",
            name = "Name",
            normalizedName = "name",
        ...
        val unitDto = com.venkoi.cuentame.core.backup.model.UnitBackupDto(
    ...
    fun `Ingredient mapping preserves null par and reorder point`() {
        val dto = com.venkoi.cuentame.core.backup.model.IngredientBackupDto(
    ...
    fun `PreparationRecipe mapping round-trip`() {
        val dto = com.venkoi.cuentame.core.backup.model.PreparationRecipeBackupDto(
            id = "rec-1",
            restaurantId = "rest-1",
    ...
    fun `PreparationRecipeComponent mapping round-trip`() {
        val dto = com.venkoi.cuentame.core.backup.model.PreparationRecipeComponentBackupDto(
            id = "comp-1",
            recipeId = "rec-1",
