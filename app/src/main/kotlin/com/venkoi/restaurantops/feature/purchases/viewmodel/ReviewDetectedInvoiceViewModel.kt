...
import com.venkoi.restaurantops.core.database.repository.ActiveRestaurantProvider
...
import com.venkoi.restaurantops.core.ocr.parser.isEdited
import com.venkoi.restaurantops.core.ocr.parser.matching.*
...
class ReviewDetectedInvoiceViewModel @Inject constructor(
    ...
    private val idGenerator: com.venkoi.restaurantops.core.common.ids.IdGenerator,
    ...
    private fun observeData() {
        viewModelScope.launch {
            ...
            combine(
                ...
                val activeRestaurant = array[3] as com.venkoi.restaurantops.core.database.entity.RestaurantEntity?
    ...
    fun onConfirmMatch(
        ...
        viewModelScope.launch {
            try {
                ...
                val error = when (e) {
                    is com.venkoi.restaurantops.core.domain.validation.ValidationError -> when (e) {
                        com.venkoi.restaurantops.core.domain.validation.ValidationError.ParseResultChanged -> MatchConfirmationError.SourceChanged
                        com.venkoi.restaurantops.core.domain.validation.ValidationError.InvoiceSourceLocked -> MatchConfirmationError.SourceLocked
                        com.venkoi.restaurantops.core.domain.validation.ValidationError.InvalidMatchStatus,
                        com.venkoi.restaurantops.core.domain.validation.ValidationError.InvalidPurchaseUnitOption,
                        com.venkoi.restaurantops.core.domain.validation.ValidationError.InvalidPurchaseArea -> MatchConfirmationError.InvalidSelection
    ...
    fun onUpdateHeaderCorrections(corrections: com.venkoi.restaurantops.core.ocr.parser.PurchaseInvoiceCorrections) {
        viewModelScope.launch {
    ...
    fun onUpdateLineCorrection(lineIndex: Int, isIgnored: Boolean, correction: com.venkoi.restaurantops.core.ocr.parser.ParsedInvoiceLineCorrection?) {
        viewModelScope.launch {
            val result = uiState.value.result ?: return@launch
    ...
    private fun identityFieldsChanged(oldLine: ParsedInvoiceLineCandidate, newCorrection: com.venkoi.restaurantops.core.ocr.parser.ParsedInvoiceLineCorrection?): Boolean {
    ...
    private suspend fun triggerAutoMatchingForLine(lineIndex: Int, correction: com.venkoi.restaurantops.core.ocr.parser.ParsedInvoiceLineCorrection?) {
        val result = uiState.value.result ?: return
    ...
    fun onAddMissingLine(correction: com.venkoi.restaurantops.core.ocr.parser.ParsedInvoiceLineCorrection) {
        viewModelScope.launch {
    ...
    fun onResetHeader() {
        viewModelScope.launch {
            val result = repository.updateParseResult(receiptId, com.venkoi.restaurantops.core.ocr.parser.PurchaseInvoiceCorrections())
            if (result == SourceMutationResult.SourceLocked) {
                _uiState.update { it.copy(materializationFailure = PurchaseInvoiceMaterializationFailure.InvoiceSourceLocked) }
            }
        }
