...
import com.venkoi.cuentame.core.backup.PackageArchitectureRules
...
class ArchitectureTest {
    ...
    fun enforcePackageBoundaries() {
        ...
        val sourceDir = File(rootDir, "app/src/main/kotlin/com/venkoi/cuentame")
        ...
        sourceDir.walkTopDown().filter { it.extension == "kt" }.forEach { file ->
            filesInspected++
            val relativePath = file.absolutePath.substringAfter("com/venkoi/cuentame/")
    ...
    fun ruleModelToDatabaseViolationDetected() {
        val source = "import com.venkoi.cuentame.core.database.entity.UserEntity\nclass M"
    ...
    fun rulePureBackupToDatabaseViolationDetected() {
        val source = "import com.venkoi.cuentame.core.database.entity.PurchaseReceiptEntity\nclass V"
    ...
    fun ruleCoreToFeatureViolationDetected() {
        val source = "import com.venkoi.cuentame.feature.home.HomeViewModel\nclass P"
    ...
    fun aliasedForbiddenImportDetected() {
        val source = "import com.venkoi.cuentame.core.database.entity.UserEntity as U\nclass M"
        val violations = PackageArchitectureRules.violations("core/model/M.kt", source)
