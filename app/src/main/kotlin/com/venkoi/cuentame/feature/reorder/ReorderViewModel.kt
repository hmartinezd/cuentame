...
import com.venkoi.cuentame.core.domain.service.ReorderCalculator
...
class ReorderViewModel @Inject constructor(
    ...
    private data class RoomSources(
        val ingredients: List<com.venkoi.cuentame.core.database.entity.IngredientEntity>,
        val options: List<com.venkoi.cuentame.core.database.entity.IngredientUnitOptionEntity>,
        val balances: List<com.venkoi.cuentame.core.database.entity.InventoryBalanceProjectionEntity>,
        val areas: List<com.venkoi.cuentame.core.database.entity.InventoryAreaEntity>,
        val mappings: List<com.venkoi.cuentame.core.database.entity.SupplierItemMappingEntity>
    )
    ...
    private val source = activeRestaurant.observeActiveRestaurant().filterNotNull().flatMapLatest { restaurant ->
        ...
        combine(roomSources, supplierRepository.observeSuppliers(com.venkoi.cuentame.core.common.ids.RestaurantId(id), false), unitRepository.observeAll()) { room, suppliers, units ->
