...
class RoomDetailedReportsRepositoryTest {
    ...
    fun observeInventoryDetails_strictDecimalValidation() = runBlocking {
        ...
        } catch (e: com.venkoi.cuentame.core.domain.validation.ValidationError.InvalidDecimal) {
            // Success
        }
    }
    ...
    fun observeWasteDetails_strictSnapshotValidation() = runBlocking {
        ...
        } catch (e: com.venkoi.cuentame.core.domain.validation.ValidationError.MalformedInventoryMovementHistory) {
            // Success
        }
    }
}
