...
@Composable
fun ReorderRoute(onBack: () -> Unit, onConfigureIngredient: (com.venkoi.restaurantops.core.common.ids.IngredientId) -> Unit, viewModel: ReorderViewModel = hiltViewModel()) {
...
@Composable
fun ReorderScreen(state: ReorderUiState, onFilter: (ReorderFilter) -> Unit, onBack: () -> Unit, onConfigureIngredient: (com.venkoi.restaurantops.core.common.ids.IngredientId) -> Unit) {
...
@Composable private fun ReorderCard(item: ReorderItem, onConfigureIngredient: (com.venkoi.restaurantops.core.common.ids.IngredientId) -> Unit) {
