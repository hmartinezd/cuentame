...
class RoomIngredientRepositoryTest {
    ...
    fun setup() {
        ...
        runBlocking {
            db.restaurantDao().insert(com.venkoi.cuentame.core.database.entity.RestaurantEntity(restId.value, "R", "USD", "en-US", 0L, 0L, null))
        }
    }
    ...
    fun createIngredientWithBaseOption_succeeds() = runBlocking {
        ...
        db.unitDao().insertSeedUnits(listOf(com.venkoi.cuentame.core.database.entity.UnitEntity(unitId.value, "U", "u", "MASS", BigDecimal.ONE, true, 0)))
    ...
    fun archiveUnitOption_failsIfUsedByNonArchivedRecipe() = runBlocking {
        ...
        db.ingredientDao().insert(com.venkoi.cuentame.core.database.entity.IngredientEntity(ingId.value, restId.value, "I", "i", null, "u1", null, null, null, null, true, 0, 0, null))
        db.ingredientUnitOptionDao().insert(com.venkoi.cuentame.core.database.entity.IngredientUnitOptionEntity(optId.value, ingId.value, "O", "o", null, BigDecimal.ONE, false, false, false, true, 0, 0, null))

        // Create a draft recipe using this option
        db.preparationRecipeDao().insert(com.venkoi.cuentame.core.database.entity.PreparationRecipeEntity(
        ...
        } catch (e: com.venkoi.cuentame.core.domain.validation.ValidationError) {
            assertThat(e).isEqualTo(com.venkoi.cuentame.core.domain.validation.ValidationError.UnitOptionUsedByRecipe)
        }
    }
    ...
    fun archiveIngredient_failsIfOutputOfNonArchivedRecipe() = runBlocking {
        ...
        try {
            ...
            assertThat(e).isEqualTo(com.venkoi.cuentame.core.domain.validation.ValidationError.IngredientIsRecipeOutput)
        }
    }
    ...
    fun archiveIngredient_failsIfUsedByProductionDraft() = runBlocking {
        ...
        val ingId = IngredientId("i1")
        db.ingredientDao().insert(com.venkoi.cuentame.core.database.entity.IngredientEntity(ingId.value, restId.value, "I", "i", null, "u1", null, null, null, null, true, 0, 0, null))
        db.ingredientUnitOptionDao().insert(com.venkoi.cuentame.core.database.entity.IngredientUnitOptionEntity("opt1", "i1", "lb", "lb", null, BigDecimal.ONE, true, true, true, true, 0, 0, null))

        // Seed Area and Recipe (not outputting i1)
        val ing2 = "i2"
        db.ingredientDao().insert(com.venkoi.cuentame.core.database.entity.IngredientEntity(ing2, restId.value, "I2", "i2", null, "u1", null, null, null, null, true, 0, 0, null))
        db.inventoryAreaDao().upsert(com.venkoi.cuentame.core.database.entity.InventoryAreaEntity("a1", restId.value, "A", "a", 0, true, 0, 0, null))
        db.preparationRecipeDao().insert(com.venkoi.cuentame.core.database.entity.PreparationRecipeEntity("r1", restId.value, ing2, "R", "r", BigDecimal.ONE, BigDecimal.ONE, null, "ACTIVE", null, 0, 0, null))

        // Create a draft batch using i1 as output (even if recipe outputs i2, the batch entity allows override for testing purposes)
        db.productionBatchDao().insert(com.venkoi.cuentame.core.database.entity.ProductionBatchEntity(
        ...
        try {
            ...
            assertThat(e).isEqualTo(com.venkoi.cuentame.core.domain.validation.ValidationError.IngredientUsedByProductionDraft)
        }
    }
}
