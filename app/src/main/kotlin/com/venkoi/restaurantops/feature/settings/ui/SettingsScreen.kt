...
import com.venkoi.restaurantops.feature.settings.presentation.toUserMessageRes
import androidx.compose.material.icons.filled.Restore
import com.venkoi.restaurantops.core.model.locale.SupportedAppLocale
import com.venkoi.restaurantops.feature.settings.viewmodel.BackupRestoreUiState
import com.venkoi.restaurantops.feature.settings.viewmodel.BackupRestoreViewModel
...
import com.venkoi.restaurantops.core.backup.api.BackupRestoreProgress
import com.venkoi.restaurantops.core.model.backup.BackupRestoreEligibility
import com.venkoi.restaurantops.feature.settings.viewmodel.BackupOperationId
import com.venkoi.restaurantops.feature.settings.viewmodel.BackupUiEvent
import com.venkoi.restaurantops.feature.settings.viewmodel.BackupUiState
import com.venkoi.restaurantops.feature.settings.viewmodel.BackupViewModel
import com.venkoi.restaurantops.feature.settings.viewmodel.SettingsViewModel
        ...
        backupViewModel.events.collect { event ->
            when (event) {
                ...
                is BackupUiEvent.ShareDiagnosticReport -> {
                    com.venkoi.restaurantops.core.common.util.ShareHelper.shareTextFile(
                        context = context,
...
fun SettingsScreen(
    ...
    isSaving: Boolean,
    backupUiState: BackupUiState,
    autoBackupStatus: com.venkoi.restaurantops.feature.settings.viewmodel.AutoBackupUiStatus,
    ...
    when (val state = restoreUiState) {
        ...
        BackupRestoreUiState.RecoveryRequired -> {
            RestoreErrorDialog(
                failure = com.venkoi.restaurantops.core.model.backup.BackupRestoreFailure.RecoveryRequired,
                onDismiss = {},
...
fun RestorePreviewDialog(
    preview: com.venkoi.restaurantops.core.model.backup.BackupRestorePreview,
...
fun RestoreSuccessDialog(
    summary: com.venkoi.restaurantops.feature.settings.viewmodel.BackupRestoreSuccessSummary,
    onDismiss: () -> Unit
) {
    AlertDialog(
        onDismissRequest = onDismiss,
...
fun RestoreErrorDialog(
    failure: com.venkoi.restaurantops.core.model.backup.BackupRestoreFailure,
    onDismiss: () -> Unit,
    onRetry: (() -> Unit)?,
