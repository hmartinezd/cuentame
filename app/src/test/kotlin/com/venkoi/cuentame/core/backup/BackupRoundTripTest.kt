...
import com.venkoi.cuentame.core.backup.fakes.*
import com.venkoi.cuentame.core.backup.platform.DefaultBackupArchiveValidator
import com.venkoi.cuentame.core.backup.platform.DefaultBackupArchiveWriter
...
class BackupRoundTripTest {
    ...
    fun setup() {
        ...
        val processor = com.venkoi.cuentame.core.backup.internal.BackupArchiveProcessor(BackupReadLimits()) { input -> java.util.zip.ZipInputStream(input) }
        val fingerprinter = com.venkoi.cuentame.core.backup.internal.BackupArchiveFingerprinter(jsonCodecs)
        reader = com.venkoi.cuentame.core.backup.platform.DefaultBackupArchiveReader(jsonCodecs, processor, fingerprinter)
    ...
    fun `complete round trip with no attachments`() = runTest {
        ...
        preferencesSource.result = com.venkoi.cuentame.core.model.backup.BackupPreferencesDto("SYSTEM", true, "en-US")
