...
class RoomProductionBatchRepositoryFailureTest {
    ...
    fun voidPosted_withCorruptedHistory_returnsMovementHistoryConflict() = runBlocking {
        ...
        assertThat(batch.status).isEqualTo(com.venkoi.restaurantops.core.model.inventory.DocumentStatus.POSTED)
    ...
    private data class ProductionSnapshot(
        ...
        val balanceProjections: List<com.venkoi.restaurantops.core.database.entity.InventoryBalanceProjectionEntity>,
        val costProjections: List<com.venkoi.restaurantops.core.database.entity.IngredientCostProjectionEntity>
    )
