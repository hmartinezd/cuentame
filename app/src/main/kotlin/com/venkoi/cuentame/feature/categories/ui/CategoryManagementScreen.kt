package com.venkoi.cuentame.feature.categories.ui
...
import com.venkoi.cuentame.feature.categories.viewmodel.CategoryManagementEvent
import com.venkoi.cuentame.feature.categories.viewmodel.CategoryManagementViewModel
...
fun CategoryManagementRoute(
    ...
    var categoryToArchive by remember { mutableStateOf<com.venkoi.cuentame.core.model.ingredient.IngredientCategory?>(null) }
    var categoryToEdit by remember { mutableStateOf<com.venkoi.cuentame.core.model.ingredient.IngredientCategory?>(null) }
...
fun CategoryManagementScreen(
    uiState: com.venkoi.cuentame.feature.categories.viewmodel.CategoryManagementUiState,
    categoryToArchive: com.venkoi.cuentame.core.model.ingredient.IngredientCategory?,
    categoryToEdit: com.venkoi.cuentame.core.model.ingredient.IngredientCategory?,
    newCategoryName: String,
    snackbarHostState: SnackbarHostState,
    onNewCategoryNameChange: (String) -> Unit,
    onSetCategoryToArchive: (com.venkoi.cuentame.core.model.ingredient.IngredientCategory?) -> Unit,
    onSetCategoryToEdit: (com.venkoi.cuentame.core.model.ingredient.IngredientCategory?) -> Unit,
    onAddCategory: (String) -> Unit,
    onUpdateCategory: (com.venkoi.cuentame.core.model.ingredient.IngredientCategory) -> Unit,
    onArchiveCategory: (com.venkoi.cuentame.core.model.ingredient.IngredientCategory) -> Unit,
    onMoveUp: (Int) -> Unit,
    onMoveDown: (Int) -> Unit
) {
    Scaffold(
...
@Composable
fun CategoryItem(
    category: com.venkoi.cuentame.core.model.ingredient.IngredientCategory,
    canMoveUp: Boolean,
    canMoveDown: Boolean,
    isEnabled: Boolean,
    onMoveUp: () -> Unit,
