...
class ProductionBatchPostingPreviewScreenTest {
    ...
    private fun mockkPreview() = com.venkoi.restaurantops.core.domain.repository.ProductionBatchPostingPreview(
        batchId = com.venkoi.restaurantops.core.common.ids.ProductionBatchId("b1"),
