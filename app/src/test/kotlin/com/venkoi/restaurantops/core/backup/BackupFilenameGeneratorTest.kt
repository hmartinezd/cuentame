...
class BackupFilenameGeneratorTest {
    ...
    fun `generates valid name with restaurant`() {
        ...
        assertThat(name).isEqualTo("RestaurantOps_My_Restaurant_2026-07-29_1200.venkoi-backup")
    }
    ...
    fun `generates valid name without restaurant`() {
        ...
        assertThat(name).isEqualTo("RestaurantOps_Backup_2026-07-29_1200.venkoi-backup")
    }
    ...
    fun `sanitizes restaurant name`() {
        ...
        assertThat(name).isEqualTo("RestaurantOps_Rest_Name_2026-07-29_1200.venkoi-backup")
    }
}
