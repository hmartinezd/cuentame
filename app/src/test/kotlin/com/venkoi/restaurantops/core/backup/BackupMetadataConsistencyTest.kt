...
class BackupMetadataConsistencyTest {
    ...
    private fun createPopulatedCurrentSnapshot() = BackupSnapshotDto(
        restaurants = listOf(com.venkoi.restaurantops.core.backup.model.RestaurantBackupDto("r1", "Test", "USD", "en-US", 100, 100, null)),
    ...
    private fun createManifestForSnapshot(
        ...
        val tableMetadata = mutableMapOf<String, com.venkoi.restaurantops.core.model.backup.TableMetadata>()
        ...
        for (table in expectedTables) {
            ...
            tableMetadata[table] = com.venkoi.restaurantops.core.model.backup.TableMetadata(
                entryCount = count,
