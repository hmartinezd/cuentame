...
import com.venkoi.restaurantops.feature.purchases.presentation.toUserMessageRes
import com.venkoi.restaurantops.feature.purchases.viewmodel.InvoiceCaptureState
import com.venkoi.restaurantops.feature.purchases.viewmodel.OcrAnalysisState
import com.venkoi.restaurantops.feature.purchases.viewmodel.PurchaseDraftEvent
import com.venkoi.restaurantops.feature.purchases.viewmodel.PurchaseDraftUiState
import com.venkoi.restaurantops.feature.purchases.viewmodel.PurchaseDraftViewModel
        ...
        AlertDialog(
            ...
            text = {
                Column {
                    Text(
                        when (duplicate.type) {
                            com.venkoi.restaurantops.core.model.purchase.DuplicateInvoiceType.SAME_DOCUMENT ->
                                stringResource(R.string.ocr_duplicate_same_document)
                            com.venkoi.restaurantops.core.model.purchase.DuplicateInvoiceType.SAME_SUPPLIER_INVOICE_NUMBER ->
