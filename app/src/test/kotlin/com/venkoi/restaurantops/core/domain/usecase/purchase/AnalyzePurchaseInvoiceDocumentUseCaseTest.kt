...
import com.venkoi.restaurantops.core.common.hash.HashUtils
import com.venkoi.restaurantops.core.common.image.SafeImageDecoder
...
import com.venkoi.restaurantops.core.ocr.FakePurchaseInvoiceOcrEngine
...
class AnalyzePurchaseInvoiceDocumentUseCaseTest {
    ...
    fun atomicPersistenceFailureOnSecondPageKeepsOldResult() = runTest {
        ...
        val bitmap = mockk<Bitmap>(relaxed = true)
        coEvery { pdfRenderer.renderPage(any(), 0, any()) } returns PurchasePdfPageRenderResult.Success(bitmap)
        coEvery { pdfRenderer.renderPage(any(), 1, any()) } returns PurchasePdfPageRenderResult.Failure(com.venkoi.restaurantops.core.backup.api.PurchasePdfRenderFailure.RenderFailed)
