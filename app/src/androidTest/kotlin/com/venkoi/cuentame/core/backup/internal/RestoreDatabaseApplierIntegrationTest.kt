...
import com.venkoi.cuentame.core.backup.platform.RoomBackupSnapshotSource
...
class RestoreDatabaseApplierIntegrationTest {
    ...
    fun existing_data_is_fully_replaced() = runBlocking {
        ...
        db.inventoryAreaDao().upsert(com.venkoi.cuentame.core.database.entity.InventoryAreaEntity("a1", "r1", "Area 1", "area 1", 0, true, 0, 0, null))
        db.unitDao().insertSeedUnits(listOf(com.venkoi.cuentame.core.database.entity.UnitEntity("u1", "U", "u", "MASS", java.math.BigDecimal.ONE, true, 0)))
        db.ingredientDao().insert(com.venkoi.cuentame.core.database.entity.IngredientEntity("i1", "r1", "Ing 1", "ing 1", null, "u1", "a1", null, null, null, true, 0, 0, null))
        
        // 2. Prepare backup snapshot (State B - Materially different)
        val snapshotB = createMinimalSnapshot("r2", "New").copy(
            inventoryAreas = listOf(com.venkoi.cuentame.core.backup.model.InventoryAreaBackupDto("a2", "r2", "Area 2", "area 2", 0, true, 0, 0, null))
        )
    ...
    fun incoming_no_attachment_backup_produces_null_attachment_paths() = runBlocking {
        ...
        val snapshot = createMinimalSnapshot("r1", "R").copy(
            purchaseReceipts = listOf(com.venkoi.cuentame.core.backup.model.PurchaseReceiptBackupDto(
    ...
    fun replaceWithBackup_atomicity_on_failure() = runBlocking {
        ...
        db.unitDao().insertSeedUnits(listOf(com.venkoi.cuentame.core.database.entity.UnitEntity("u1", "U", "u", "MASS", java.math.BigDecimal.ONE, true, 0)))
        db.ingredientDao().insert(com.venkoi.cuentame.core.database.entity.IngredientEntity("i1", "r1", "Ing 1", "ing 1", null, "u1", "a1", null, null, null, true, 0, 0, null))
        db.inventoryProjectionDao().upsert(com.venkoi.cuentame.core.database.entity.InventoryBalanceProjectionEntity("r1", "i1", "a1", "100", 1000L))
        ...
        val snapshotB = createMinimalSnapshot("r2", "State B").copy(
            purchaseLines = listOf(com.venkoi.cuentame.core.backup.model.PurchaseLineBackupDto(
                id = "pl1",
        ...
        val manifestB = com.venkoi.cuentame.core.model.backup.BackupManifest(
            backupFormatVersion = 1,
            createdAtUtc = "2026-01-01T12:00:00Z",
            applicationId = "com.venkoi.cuentame",
            appVersionName = "1.0",
    ...
    private fun createMinimalSnapshot(id: String, name: String) = BackupSnapshotDto(
        restaurants = listOf(com.venkoi.cuentame.core.backup.model.RestaurantBackupDto(id, name, "USD", "en-US", 0, 0, null)),
