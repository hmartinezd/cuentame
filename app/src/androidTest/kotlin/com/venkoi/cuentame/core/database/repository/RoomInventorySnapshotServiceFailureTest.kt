...
class RoomInventorySnapshotServiceFailureTest {
    ...
    fun setup() {
        ...
        runBlocking {
            ...
            db.inventoryAreaDao().upsert(com.venkoi.cuentame.core.database.entity.InventoryAreaEntity(areaId.value, restaurantId.value, "Area 1", "area 1", 0, true, 0, 0, null))
    ...
    fun calculateAt_reversal_identityMismatch_throws() = runBlocking {
        ...
        db.inventoryAreaDao().upsert(
            com.venkoi.cuentame.core.database.entity.InventoryAreaEntity(
                "area_2",
                restaurantId.value,
                "Area 2",
                "area_2",
