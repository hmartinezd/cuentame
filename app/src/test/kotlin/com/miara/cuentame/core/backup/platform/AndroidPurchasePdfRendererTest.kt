...
class AndroidPurchasePdfRendererTest {
    ...
    fun `renderPage missing file returns FileMissing`() = runTest {
        ...
        assertThat(result).isInstanceOf(com.miara.cuentame.core.backup.api.PurchasePdfPageRenderResult.Failure::class.java)
        val failure = result as com.miara.cuentame.core.backup.api.PurchasePdfPageRenderResult.Failure
