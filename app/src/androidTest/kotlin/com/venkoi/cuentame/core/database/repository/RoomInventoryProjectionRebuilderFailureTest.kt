...
import com.venkoi.cuentame.core.database.entity.IngredientCostProjectionEntity
...
class RoomInventoryProjectionRebuilderFailureTest {
    ...
    fun setup() {
        ...
        runBlocking {
            db.restaurantDao().insert(com.venkoi.cuentame.core.database.entity.RestaurantEntity(restaurantId.value, "Rest 1", "USD", "en-US", 0, 0, null))
            db.unitDao().insertSeedUnits(listOf(com.venkoi.cuentame.core.database.entity.UnitEntity("mass_lb", "Pound", "lb", "MASS", BigDecimal.ONE, true, 0)))
            db.inventoryAreaDao().upsert(com.venkoi.cuentame.core.database.entity.InventoryAreaEntity(areaId, restaurantId.value, "Area 1", "area 1", 0, true, 0, 0, null))
            db.ingredientDao().insert(com.venkoi.cuentame.core.database.entity.IngredientEntity(ingredientId.value, restaurantId.value, "Ing 1", "ing 1", null, "mass_lb", null, null, null, null, true, 0, 0, null))
        }
    }
    ...
    fun rebuild_wrongReversalArea_rollsBack() = runBlocking {
        ...
        db.inventoryAreaDao().upsert(com.venkoi.cuentame.core.database.entity.InventoryAreaEntity("area_2", restaurantId.value, "Area 2", "area_2", 1, true, 0, 0, null))
        val now = Instant.now()
