...
class PilotDiagnosticExporterTest {
    ...
    fun setup() {
        ...
        every { appVersionProvider.applicationId } returns "com.venkoi.test"
    ...
    private fun emptyUnitOrigins() = emptyList<com.venkoi.cuentame.core.database.entity.PurchaseInvoiceDraftApplicationEntity>()
