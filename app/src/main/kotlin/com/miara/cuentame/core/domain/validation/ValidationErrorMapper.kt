...
fun Throwable.toUserMessageRes(): Int {
    return when (this) {
        is ValidationError -> when (this) {
            ...
            // Stock Counts
            ValidationError.StockCountNotFound -> R.string.error_purchase_not_found
            ValidationError.StockCountNotDraft -> R.string.error_purchase_not_draft
            ValidationError.StockCountAlreadyCompleted -> R.string.error_purchase_already_posted
            ValidationError.StockCountAlreadyVoided -> R.string.error_purchase_already_voided
            ValidationError.StockCountHasNoLines -> R.string.error_purchase_no_lines
