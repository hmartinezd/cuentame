package com.venkoi.restaurantops.feature.activity
...
class InventoryActivityUiTest {
    ...
    private fun scrollToActivityRow(movementId: com.venkoi.restaurantops.core.common.ids.InventoryMovementId) {
    ...
    private fun waitForActivityDetail(movementId: com.venkoi.restaurantops.core.common.ids.InventoryMovementId) {
