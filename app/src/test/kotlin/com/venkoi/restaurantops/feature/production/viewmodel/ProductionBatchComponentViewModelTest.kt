...
class ProductionBatchComponentViewModelTest {
    ...
    fun `unit not in available options rejected during save`() = runTest {
        ...
        assertEquals("Should have rejected invalid unit", 
            com.venkoi.restaurantops.core.presentation.ui.UiMessage.Resource(com.venkoi.restaurantops.R.string.error_unit_option_not_found), 
    ...
    fun `loading failure sets screenState to LoadError with error_generic`() = runTest {
        ...
        assertEquals(com.venkoi.restaurantops.R.string.error_generic, (error as UiMessage.Resource).id)
    }
    ...
    fun `save failure sets inlineError to error_generic and preserves form values`() = runTest {
        ...
        assertEquals(com.venkoi.restaurantops.R.string.error_generic, (state.inlineError as UiMessage.Resource).id)
        assertNotEquals(com.venkoi.restaurantops.R.string.saved, (state.inlineError as UiMessage.Resource).id)
    }
