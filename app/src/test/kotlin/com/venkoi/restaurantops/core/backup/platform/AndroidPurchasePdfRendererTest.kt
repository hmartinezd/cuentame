...
class AndroidPurchasePdfRendererTest {
    ...
    fun `renderPage missing file returns FileMissing`() = runTest {
        ...
        assertThat(result).isInstanceOf(com.venkoi.restaurantops.core.backup.api.PurchasePdfPageRenderResult.Failure::class.java)
        val failure = result as com.venkoi.restaurantops.core.backup.api.PurchasePdfPageRenderResult.Failure
