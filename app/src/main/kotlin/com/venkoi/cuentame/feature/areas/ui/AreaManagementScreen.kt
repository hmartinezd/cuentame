package com.venkoi.cuentame.feature.areas.ui
...
import com.venkoi.cuentame.feature.areas.viewmodel.AreaManagementEvent
import com.venkoi.cuentame.feature.areas.viewmodel.AreaManagementViewModel
...
fun AreaManagementRoute(
    ...
    var areaToArchive by remember { mutableStateOf<com.venkoi.cuentame.core.model.inventory.InventoryArea?>(null) }
    var areaToEdit by remember { mutableStateOf<com.venkoi.cuentame.core.model.inventory.InventoryArea?>(null) }
...
fun AreaManagementScreen(
    uiState: com.venkoi.cuentame.feature.areas.viewmodel.AreaManagementUiState,
    areaToArchive: com.venkoi.cuentame.core.model.inventory.InventoryArea?,
    areaToEdit: com.venkoi.cuentame.core.model.inventory.InventoryArea?,
    newAreaName: String,
    snackbarHostState: SnackbarHostState,
    onNewAreaNameChange: (String) -> Unit,
    onSetAreaToArchive: (com.venkoi.cuentame.core.model.inventory.InventoryArea?) -> Unit,
    onSetAreaToEdit: (com.venkoi.cuentame.core.model.inventory.InventoryArea?) -> Unit,
    onViewActivity: (InventoryAreaId) -> Unit,
    onAddArea: (String) -> Unit,
    onUpdateArea: (com.venkoi.cuentame.core.model.inventory.InventoryArea) -> Unit,
    onArchiveArea: (com.venkoi.cuentame.core.model.inventory.InventoryArea) -> Unit,
    onMoveUp: (Int) -> Unit,
    onMoveDown: (Int) -> Unit,
    onBack: () -> Unit
) {
...
@Composable
fun AreaItem(
    area: com.venkoi.cuentame.core.model.inventory.InventoryArea,
    canMoveUp: Boolean,
    canMoveDown: Boolean,
    isEnabled: Boolean,
    onMoveUp: () -> Unit,
