...
interface IngredientDao {
    ...
    @Query("SELECT * FROM ingredients WHERE normalizedName = :normalizedName AND deletedAt IS NULL LIMIT 1")
    suspend fun findByNormalizedName(normalizedName: String): IngredientEntity?
