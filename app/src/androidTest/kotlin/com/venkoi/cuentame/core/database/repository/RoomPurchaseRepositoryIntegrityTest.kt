...
class RoomPurchaseRepositoryIntegrityTest {
    ...
    fun confirmInvoiceLineMatch_revalidatesParseResultId() = runBlocking {
        ...
        database.purchaseOcrDao().insertOcrResult(com.venkoi.cuentame.core.database.entity.PurchaseInvoiceOcrResultEntity(
    ...
    fun confirmInvoiceLineMatch_revalidatesSupplierId() = runBlocking {
        ...
        database.supplierDao().insert(com.venkoi.cuentame.core.database.entity.SupplierEntity(supplierA.value, restId.value, "Sup A", "sup-a", null, null, null, true, 0, 0, null))
        database.supplierDao().insert(com.venkoi.cuentame.core.database.entity.SupplierEntity(supplierB.value, restId.value, "Sup B", "sup-b", null, null, null, true, 0, 0, null))
        ...
        repository.updateDraft(com.venkoi.cuentame.core.domain.repository.UpdatePurchaseDraftCommand(receiptId, supplierB, "INV-1", Instant.now(), null))
