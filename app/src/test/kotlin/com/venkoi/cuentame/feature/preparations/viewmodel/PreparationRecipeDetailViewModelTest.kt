...
class PreparationRecipeDetailViewModelTest {
    ...
    private fun cost(status: PreparationCostStatus, total: BigDecimal?) = PreparationRecipeCost(
        ...
        HistoricalPreparationCost(com.venkoi.cuentame.core.common.ids.ProductionBatchId("batch"), Instant.EPOCH, BigDecimal.TEN, BigDecimal.ONE)
    )

    private fun componentWithReason(reason: PreparationCostMissingReason) = PreparationComponentCost(
        com.venkoi.cuentame.core.common.ids.PreparationRecipeComponentId("component"), IngredientId("nested"), "Nested",
