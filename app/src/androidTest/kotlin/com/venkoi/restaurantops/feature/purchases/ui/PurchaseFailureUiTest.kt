...
import com.venkoi.restaurantops.core.database.repository.IntegrationFailurePoints
...
import com.venkoi.restaurantops.core.database.seed.UnitSeeds
...
class PurchaseFailureUiTest {
    ...
    @Inject
    lateinit var failureBoundary: com.venkoi.restaurantops.core.database.repository.IntegrationFailureBoundary
    ...
    fun purchasePost_rollback_andRetry_onFailure() {
        ...
        runBlocking {
            ...
            database.purchaseDao().insertReceipt(
                com.venkoi.restaurantops.core.database.entity.PurchaseReceiptEntity(
                    id = receiptId,
            ...
            database.purchaseDao().insertLine(
                com.venkoi.restaurantops.core.database.entity.PurchaseLineEntity(
                    id = "line_1",
        ...
        ActivityScenario.launch(MainActivity::class.java).use {
            ...
            runBlocking {
                ...
                assertThat(movements[0].movementType).isEqualTo(com.venkoi.restaurantops.core.model.inventory.InventoryMovementType.PURCHASE.name)
