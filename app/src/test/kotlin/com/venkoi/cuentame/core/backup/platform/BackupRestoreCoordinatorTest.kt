...
class BackupRestoreCoordinatorTest {
    ...
    private val operationGate = com.venkoi.cuentame.core.backup.internal.RestoreOperationGate()
    ...
    private fun createEmptySnapshot() = com.venkoi.cuentame.core.backup.model.BackupSnapshotDto(
