...
import com.venkoi.cuentame.core.backup.api.RestoreRecoveryResult
...
class RestoreRecoveryCoordinatorTest {
    ...
    fun `recovery requires recovery when preference verification fails`() = runTest {
        ...
        assertThat(recovery.category).isEqualTo(com.venkoi.cuentame.core.backup.api.RecoveryFailureCategory.VERIFICATION_FAILED)
    ...
    fun `corrupt journal results in RecoveryRequired`() = runTest {
        ...
        assertThat(result).isInstanceOf(RestoreRecoveryResult.RecoveryRequired::class.java)
        val recovery = result as RestoreRecoveryResult.RecoveryRequired
        assertThat(recovery.category).isEqualTo(com.venkoi.cuentame.core.backup.api.RecoveryFailureCategory.JOURNAL_CORRUPT)
    }
    ...
    fun `missing rollback snapshot after mutation results in RecoveryRequired`() = runTest {
        ...
        assertThat(result).isInstanceOf(RestoreRecoveryResult.RecoveryRequired::class.java)
        val recovery = result as RestoreRecoveryResult.RecoveryRequired
        assertThat(recovery.category).isEqualTo(com.venkoi.cuentame.core.backup.api.RecoveryFailureCategory.SNAPSHOT_MISSING)
    }
    ...
    fun `recovery fails if database rollback fails`() = runTest {
        ...
        assertThat(result).isInstanceOf(RestoreRecoveryResult.RecoveryRequired::class.java)
        val recovery = result as RestoreRecoveryResult.RecoveryRequired
        assertThat(recovery.category).isEqualTo(com.venkoi.cuentame.core.backup.api.RecoveryFailureCategory.DATABASE_RESTORE_FAILED)
    ...
    fun `cleanup failure from COMPLETED returns RecoveryRequired`() = runTest {
        ...
        assertThat(result).isInstanceOf(RestoreRecoveryResult.RecoveryRequired::class.java)
        val recovery = result as RestoreRecoveryResult.RecoveryRequired
        assertThat(recovery.category).isEqualTo(com.venkoi.cuentame.core.backup.api.RecoveryFailureCategory.CLEANUP_FAILED)
    }
    ...
    private fun createMinimalSnapshot() = com.venkoi.cuentame.core.backup.model.BackupSnapshotDto(
