...
import com.venkoi.cuentame.core.backup.internal.RoomRestoreDatabaseApplier
import dagger.Binds
...
interface BackupModule {
    ...
    @Binds
    @Singleton
    fun bindRestoreDatabaseApplier(impl: RoomRestoreDatabaseApplier): com.venkoi.cuentame.core.backup.internal.RestoreDatabaseApplier
