...
class GetMissingCountItemsUseCase @Inject constructor(
    ...
    suspend operator fun invoke(
        ...
        val activeCandidates = mutableListOf<com.venkoi.cuentame.core.model.ingredient.Ingredient>()
        val missingActiveCandidates = mutableListOf<com.venkoi.cuentame.core.model.ingredient.Ingredient>()
