...
data class PreparationRecipeEditorUiState(
    ...
    val selectedYieldUnitOptionId: com.venkoi.cuentame.core.common.ids.IngredientUnitOptionId? = null,
    val notes: String = "",
    // Validation
...
class PreparationRecipeEditorViewModel @Inject constructor(
    ...
    private data class ValidatedRecipeForm(
        ...
        val yieldUnitOptionId: com.venkoi.cuentame.core.common.ids.IngredientUnitOptionId?,
        val notes: String?
    )
