...
import com.venkoi.restaurantops.core.backup.internal.RestoreFailureInjector
import com.venkoi.restaurantops.core.backup.internal.RestoreFailureModule
import com.venkoi.restaurantops.core.backup.internal.RestoreCheckpoint
import com.venkoi.restaurantops.core.backup.internal.RestoreJournalDto
import com.venkoi.restaurantops.core.backup.internal.RestoreJournal
import com.venkoi.restaurantops.core.backup.internal.RestoreJournalReadResult
import com.venkoi.restaurantops.core.backup.internal.InternalBackupRestoreStorage
import com.venkoi.restaurantops.core.backup.internal.RestoreRecoveryCoordinator
import com.venkoi.restaurantops.core.backup.internal.RestoreAttachmentInstaller
...
class AttachmentBackupRestoreIntegrationTest {
    ...
    @Inject
    lateinit var databaseApplier: com.venkoi.restaurantops.core.backup.internal.RestoreDatabaseApplier

    @Inject
    lateinit var preferencesApplier: com.venkoi.restaurantops.core.backup.internal.RestorePreferencesApplier
