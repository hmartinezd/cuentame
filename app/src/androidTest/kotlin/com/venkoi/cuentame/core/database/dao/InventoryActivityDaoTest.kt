...
class InventoryActivityDaoTest {
    ...
    fun observeInventoryActivityRows_joinsAllSourceTypes() = runBlocking {
        ...
        assertThat(rows[2].sourceWasteReason).isEqualTo(com.venkoi.cuentame.core.model.inventory.WasteReason.SPOILED.name)
    ...
    fun observeInventoryActivityRows_resolvesReversals() = runBlocking {
        ...
        assertThat(m2Row.reversalOfMovementType).isEqualTo(com.venkoi.cuentame.core.model.inventory.InventoryMovementType.PURCHASE.name)
        ...
        assertThat(m1Row.reversedByMovementType).isEqualTo(com.venkoi.cuentame.core.model.inventory.InventoryMovementType.REVERSAL.name)
