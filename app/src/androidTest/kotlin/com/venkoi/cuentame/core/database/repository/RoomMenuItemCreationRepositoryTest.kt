...
import com.venkoi.cuentame.core.domain.repository.MenuRecipeValidationException
import com.venkoi.cuentame.core.domain.repository.NewMenuItem
import com.venkoi.cuentame.core.domain.repository.NewMenuItemComponent
...
class RoomMenuItemCreationRepositoryTest {
    ...
    private fun request(menuId: String, categoryId: String, name: String) = NewMenuItem(
        menuId = com.venkoi.cuentame.core.common.ids.MenuId(menuId),
        categoryId = com.venkoi.cuentame.core.common.ids.MenuCategoryId(categoryId),
        name = name,
