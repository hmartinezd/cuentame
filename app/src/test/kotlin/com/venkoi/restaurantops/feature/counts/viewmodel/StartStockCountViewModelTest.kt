package com.venkoi.restaurantops.feature.counts.viewmodel
...
import com.venkoi.restaurantops.core.domain.usecase.ObserveInventoryAreasUseCase
...
class StartStockCountViewModelTest {
    ...
    private val fakeStockCountRepository = object : StockCountRepository {
        ...
        override fun observeCountArea(id: com.venkoi.restaurantops.core.common.ids.StockCountAreaId) = flowOf(null)
        ...
        override suspend fun start(command: com.venkoi.restaurantops.core.domain.repository.StartStockCountCommand): StockCountId = StockCountId("c1")
        override suspend fun updateDraft(command: com.venkoi.restaurantops.core.domain.repository.UpdateStockCountDraftCommand) {}
        override suspend fun saveLine(command: com.venkoi.restaurantops.core.domain.repository.SaveStockCountLineCommand) =
            com.venkoi.restaurantops.core.model.count.StockCountLine(
                com.venkoi.restaurantops.core.common.ids.StockCountLineId("l1"), command.countAreaId,
        ...
        override suspend fun deleteLine(countId: StockCountId, countAreaId: com.venkoi.restaurantops.core.common.ids.StockCountAreaId, lineId: com.venkoi.restaurantops.core.common.ids.StockCountLineId) {}
        override suspend fun completeArea(countId: StockCountId, countAreaId: com.venkoi.restaurantops.core.common.ids.StockCountAreaId) {}
        override suspend fun reopenArea(countId: StockCountId, countAreaId: com.venkoi.restaurantops.core.common.ids.StockCountAreaId) {}
        override suspend fun deleteDraft(countId: StockCountId) {}
        override suspend fun completeCount(countId: StockCountId) {}
        override suspend fun findDrift(countId: StockCountId) = emptyList<com.venkoi.restaurantops.core.domain.repository.StockCountDriftItem>()
        override suspend fun reconfirmLine(countId: StockCountId, lineId: com.venkoi.restaurantops.core.common.ids.StockCountLineId) {}
        override suspend fun voidCount(countId: StockCountId) {}
        override suspend fun getExportRows(countId: StockCountId) = emptyList<com.venkoi.restaurantops.core.domain.repository.StockCountExportRow>()
    }
    ...
    fun setup() {
        ...
        viewModel = StartStockCountViewModel(
            ...
            ObserveInventoryAreasUseCase(object : com.venkoi.restaurantops.core.domain.repository.InventoryAreaRepository {
