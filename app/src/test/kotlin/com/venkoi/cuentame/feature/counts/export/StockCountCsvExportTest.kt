package com.venkoi.cuentame.feature.counts.export
...
class StockCountCsvExportTest {
    ...
    @Test(expected = com.venkoi.cuentame.core.domain.validation.ValidationError.MalformedStockCountMovementHistory::class)
