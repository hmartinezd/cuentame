package com.venkoi.restaurantops.core.database.migration
...
class Migration7To8Test {
    ...
    fun migrate7To8_createsMappingAndMatchTables() = runBlocking {
        ...
        val mapping = roomDb.supplierItemMappingDao().getMapping("rest-1", "sup-1", com.venkoi.restaurantops.core.model.supplier.SupplierItemMappingKeyType.VENDOR_CODE, "001234")
        ...
        assertThat(matches[0].status).isEqualTo(com.venkoi.restaurantops.core.model.purchase.InvoiceLineMatchStatus.CONFIRMED)
