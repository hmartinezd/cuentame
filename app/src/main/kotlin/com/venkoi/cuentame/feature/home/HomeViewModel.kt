...
import com.venkoi.cuentame.core.domain.repository.DashboardRepository
...
import com.venkoi.cuentame.core.model.dashboard.*
    ...
    val uiState: StateFlow<HomeScreenState> = combine(
        ...
        if (restaurant == null) {
            ...
            combine(
                ...
                preferencesRepository?.observePreferences() ?: flowOf(com.venkoi.cuentame.core.preferences.model.AppPreferences.DEFAULT)
...
private object EmptyIngredientRepository : IngredientRepository {
    override fun observeIngredients(restaurantId: RestaurantId, includeArchived: Boolean) = flowOf(emptyList<com.venkoi.cuentame.core.model.ingredient.Ingredient>())
    override suspend fun getIngredients(restaurantId: RestaurantId, includeArchived: Boolean) = emptyList<com.venkoi.cuentame.core.model.ingredient.Ingredient>()
    override fun observeIngredient(id: com.venkoi.cuentame.core.common.ids.IngredientId) = flowOf<com.venkoi.cuentame.core.model.ingredient.Ingredient?>(null)
    override suspend fun getById(id: com.venkoi.cuentame.core.common.ids.IngredientId) = null
    override suspend fun getUnitOption(id: com.venkoi.cuentame.core.common.ids.IngredientUnitOptionId) = null
    override suspend fun updateIngredient(command: com.venkoi.cuentame.core.domain.repository.UpdateIngredientCommand) = Unit
    override suspend fun archive(id: com.venkoi.cuentame.core.common.ids.IngredientId, at: java.time.Instant) = Unit
    override fun observeUnitOptions(ingredientId: com.venkoi.cuentame.core.common.ids.IngredientId, includeArchived: Boolean) = flowOf(emptyList<com.venkoi.cuentame.core.model.ingredient.IngredientUnitOption>())
    override suspend fun getUnitOptions(ingredientId: com.venkoi.cuentame.core.common.ids.IngredientId, includeArchived: Boolean) = emptyList<com.venkoi.cuentame.core.model.ingredient.IngredientUnitOption>()
    override suspend fun addStandardUnitOption(command: com.venkoi.cuentame.core.domain.repository.AddStandardUnitOptionCommand) = Unit
    override suspend fun addPackageUnitOption(command: com.venkoi.cuentame.core.domain.repository.AddPackageUnitOptionCommand) = Unit
    override suspend fun updatePackageUnitOption(command: com.venkoi.cuentame.core.domain.repository.UpdatePackageUnitOptionCommand) = Unit
    override suspend fun setDefaultCountOption(ingredientId: com.venkoi.cuentame.core.common.ids.IngredientId, optionId: com.venkoi.cuentame.core.common.ids.IngredientUnitOptionId) = Unit
    override suspend fun setDefaultPurchaseOption(ingredientId: com.venkoi.cuentame.core.common.ids.IngredientId, optionId: com.venkoi.cuentame.core.common.ids.IngredientUnitOptionId) = Unit
    override suspend fun archiveUnitOption(id: com.venkoi.cuentame.core.common.ids.IngredientUnitOptionId, at: java.time.Instant) = Unit
    override suspend fun createIngredientWithBaseOption(ingredient: com.venkoi.cuentame.core.model.ingredient.Ingredient, baseOption: com.venkoi.cuentame.core.model.ingredient.IngredientUnitOption, additionalOptions: List<com.venkoi.cuentame.core.model.ingredient.IngredientUnitOption>) = Unit
}
...
private object EmptyStockCountRepository : StockCountRepository {
    ...
    override fun observeCount(id: com.venkoi.cuentame.core.common.ids.StockCountId) = flowOf<com.venkoi.cuentame.core.domain.repository.StockCountDetails?>(null)
    override fun observeCountArea(id: com.venkoi.cuentame.core.common.ids.StockCountAreaId) = flowOf<com.venkoi.cuentame.core.domain.repository.StockCountAreaDetails?>(null)
    override fun observeHasCompletedCount(restaurantId: RestaurantId) = flowOf(false)
    override suspend fun getCountedIngredientIds(countId: com.venkoi.cuentame.core.common.ids.StockCountId, areaId: InventoryAreaId) = emptySet<com.venkoi.cuentame.core.common.ids.IngredientId>()
    override suspend fun getDraftAreaIds(restaurantId: RestaurantId) = emptySet<InventoryAreaId>()
    override suspend fun getItemOrder(areaId: InventoryAreaId) = emptyList<com.venkoi.cuentame.core.common.ids.IngredientId>()
    override suspend fun saveItemOrder(areaId: InventoryAreaId, ingredientIds: List<com.venkoi.cuentame.core.common.ids.IngredientId>) = Unit
    override suspend fun start(command: com.venkoi.cuentame.core.domain.repository.StartStockCountCommand) = com.venkoi.cuentame.core.common.ids.StockCountId("")
    override suspend fun updateDraft(command: com.venkoi.cuentame.core.domain.repository.UpdateStockCountDraftCommand) = Unit
    override suspend fun saveLine(command: com.venkoi.cuentame.core.domain.repository.SaveStockCountLineCommand): com.venkoi.cuentame.core.model.count.StockCountLine = throw UnsupportedOperationException()
    override suspend fun deleteLine(countId: com.venkoi.cuentame.core.common.ids.StockCountId, countAreaId: com.venkoi.cuentame.core.common.ids.StockCountAreaId, lineId: com.venkoi.cuentame.core.common.ids.StockCountLineId) = Unit
    override suspend fun completeArea(countId: com.venkoi.cuentame.core.common.ids.StockCountId, countAreaId: com.venkoi.cuentame.core.common.ids.StockCountAreaId) = Unit
    override suspend fun reopenArea(countId: com.venkoi.cuentame.core.common.ids.StockCountId, countAreaId: com.venkoi.cuentame.core.common.ids.StockCountAreaId) = Unit
    override suspend fun deleteDraft(countId: com.venkoi.cuentame.core.common.ids.StockCountId) = Unit
    override suspend fun completeCount(countId: com.venkoi.cuentame.core.common.ids.StockCountId) = Unit
    override suspend fun findDrift(countId: com.venkoi.cuentame.core.common.ids.StockCountId) = emptyList<com.venkoi.cuentame.core.domain.repository.StockCountDriftItem>()
    override suspend fun reconfirmLine(countId: com.venkoi.cuentame.core.common.ids.StockCountId, lineId: com.venkoi.cuentame.core.common.ids.StockCountLineId) = Unit
    override suspend fun voidCount(countId: com.venkoi.cuentame.core.common.ids.StockCountId) = Unit
    override suspend fun getExportRows(countId: com.venkoi.cuentame.core.common.ids.StockCountId) = emptyList<com.venkoi.cuentame.core.domain.repository.StockCountExportRow>()
}
