...
import com.venkoi.restaurantops.core.model.supplier.SupplierItemMapping
import com.venkoi.restaurantops.core.ocr.parser.matching.InventoryNormalization
import com.venkoi.restaurantops.feature.ingredients.csvimport.domain.CsvParser.Companion.HEADER_BASE_UNIT
import com.venkoi.restaurantops.feature.ingredients.csvimport.domain.CsvParser.Companion.HEADER_CATEGORY
import com.venkoi.restaurantops.feature.ingredients.csvimport.domain.CsvParser.Companion.HEADER_COUNT_UNIT
import com.venkoi.restaurantops.feature.ingredients.csvimport.domain.CsvParser.Companion.HEADER_CURRENT_COST
import com.venkoi.restaurantops.feature.ingredients.csvimport.domain.CsvParser.Companion.HEADER_DEFAULT_AREA
import com.venkoi.restaurantops.feature.ingredients.csvimport.domain.CsvParser.Companion.HEADER_INGREDIENT_NAME
import com.venkoi.restaurantops.feature.ingredients.csvimport.domain.CsvParser.Companion.HEADER_PACKAGE_CONVERSION
import com.venkoi.restaurantops.feature.ingredients.csvimport.domain.CsvParser.Companion.HEADER_PURCHASE_PACKAGE
import com.venkoi.restaurantops.feature.ingredients.csvimport.domain.CsvParser.Companion.HEADER_REORDER_POINT
import com.venkoi.restaurantops.feature.ingredients.csvimport.domain.CsvParser.Companion.HEADER_SKU
import com.venkoi.restaurantops.feature.ingredients.csvimport.domain.CsvParser.Companion.HEADER_SUPPLIER
import com.venkoi.restaurantops.feature.ingredients.csvimport.domain.CsvParser.Companion.HEADER_VENDOR_CODE
...
class CsvImportService @Inject constructor(
    ...
    private fun validateRow(
        ...
        normalizedIngredientsMap: Map<String, com.venkoi.restaurantops.core.model.ingredient.Ingredient>,
        skuMap: Map<String, com.venkoi.restaurantops.core.model.ingredient.Ingredient>,
        categoriesMap: Map<String, List<com.venkoi.restaurantops.core.model.ingredient.IngredientCategory>>,
        areasMap: Map<String, com.venkoi.restaurantops.core.model.inventory.InventoryArea>,
        suppliersMap: Map<String, List<com.venkoi.restaurantops.core.model.supplier.Supplier>>,
        ...
        if (!normalizedVendorCode.isBlank()) {
            if (rawSupplier.isNullOrBlank()) {
                ...
                if (existingSupplier != null) {
                    val mappingKey = "${existingSupplier.id.value}|${com.venkoi.restaurantops.core.model.supplier.SupplierItemMappingKeyType.VENDOR_CODE}|$normalizedVendorCode"
