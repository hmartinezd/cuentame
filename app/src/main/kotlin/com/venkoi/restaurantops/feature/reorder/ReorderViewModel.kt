...
import com.venkoi.restaurantops.core.domain.service.ReorderCalculator
...
class ReorderViewModel @Inject constructor(
    ...
    private data class RoomSources(
        val ingredients: List<com.venkoi.restaurantops.core.database.entity.IngredientEntity>,
        val options: List<com.venkoi.restaurantops.core.database.entity.IngredientUnitOptionEntity>,
        val balances: List<com.venkoi.restaurantops.core.database.entity.InventoryBalanceProjectionEntity>,
        val areas: List<com.venkoi.restaurantops.core.database.entity.InventoryAreaEntity>,
        val mappings: List<com.venkoi.restaurantops.core.database.entity.SupplierItemMappingEntity>
    )
    ...
    private val source = activeRestaurant.observeActiveRestaurant().filterNotNull().flatMapLatest { restaurant ->
        ...
        combine(roomSources, supplierRepository.observeSuppliers(com.venkoi.restaurantops.core.common.ids.RestaurantId(id), false), unitRepository.observeAll()) { room, suppliers, units ->
