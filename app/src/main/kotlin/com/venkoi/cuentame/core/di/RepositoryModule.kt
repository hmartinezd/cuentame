...
import com.venkoi.cuentame.core.database.repository.RoomDashboardRepository
import com.venkoi.cuentame.core.database.repository.RoomIngredientCategoryRepository
import com.venkoi.cuentame.core.database.repository.RoomIngredientRepository
import com.venkoi.cuentame.core.database.repository.RoomInventoryAreaRepository
import com.venkoi.cuentame.core.database.repository.RoomPreparationRecipeRepository
import com.venkoi.cuentame.core.database.repository.RoomInventoryReadRepository
import com.venkoi.cuentame.core.database.repository.RoomInventorySnapshotService
import com.venkoi.cuentame.core.database.repository.RoomPurchaseRepository
import com.venkoi.cuentame.core.database.repository.RoomLocalSetupRepository
import com.venkoi.cuentame.core.database.repository.RoomRestaurantRepository
import com.venkoi.cuentame.core.database.repository.RoomStockCountRepository
import com.venkoi.cuentame.core.database.repository.RoomSupplierRepository
import com.venkoi.cuentame.core.database.repository.RoomUnitRepository
import com.venkoi.cuentame.core.database.repository.RoomWasteRepository
import com.venkoi.cuentame.core.database.repository.RoomProductionBatchRepository
import com.venkoi.cuentame.core.database.repository.RoomPreparationCostRepository
import com.venkoi.cuentame.core.database.repository.RoomMenuRecipeRepository
import com.venkoi.cuentame.core.database.repository.RoomMenuItemCreationRepository
import com.venkoi.cuentame.core.database.repository.RoomMenuCatalogRepository
import com.venkoi.cuentame.core.database.repository.RoomMenuCostRepository
import com.venkoi.cuentame.core.database.repository.RoomInventoryActivityRepository
import com.venkoi.cuentame.core.database.repository.RoomSupplierItemMappingRepository
import com.venkoi.cuentame.core.database.repository.RoomCsvImportRepository
import com.venkoi.cuentame.core.database.repository.RoomPriceIntelligenceRepository
...
import com.venkoi.cuentame.core.domain.repository.MenuRecipeRepository
import com.venkoi.cuentame.core.domain.repository.MenuItemCreationRepository
import com.venkoi.cuentame.core.domain.repository.MenuCatalogRepository
import com.venkoi.cuentame.core.domain.repository.MenuCostRepository
import com.venkoi.cuentame.core.domain.repository.InventoryActivityRepository
...
import com.venkoi.cuentame.core.domain.repository.LocalSetupRepository
...
import com.venkoi.cuentame.core.domain.repository.PriceIntelligenceRepository
import dagger.Binds
...
abstract class RepositoryModule {
    ...
    @Binds
    @Singleton
    abstract fun bindInventorySnapshotService(repo: RoomInventorySnapshotService): com.venkoi.cuentame.core.domain.service.InventorySnapshotService
    ...
    @Binds
    @Singleton
    abstract fun bindDashboardRepository(repo: RoomDashboardRepository): com.venkoi.cuentame.core.domain.repository.DashboardRepository
    ...
    @Binds @Singleton
    abstract fun bindMenuPublicationRepository(repo: com.venkoi.cuentame.core.database.repository.RoomMenuPublicationRepository): com.venkoi.cuentame.core.domain.repository.MenuPublicationRepository
    ...
    @Binds @Singleton
    abstract fun bindSalesImportRepository(repo: com.venkoi.cuentame.core.database.repository.RoomSalesImportRepository): com.venkoi.cuentame.core.domain.repository.SalesImportRepository
}
