...
import com.venkoi.cuentame.feature.purchases.presentation.toUserMessageRes
import com.venkoi.cuentame.feature.purchases.viewmodel.InvoiceCaptureState
import com.venkoi.cuentame.feature.purchases.viewmodel.OcrAnalysisState
import com.venkoi.cuentame.feature.purchases.viewmodel.PurchaseDraftEvent
import com.venkoi.cuentame.feature.purchases.viewmodel.PurchaseDraftUiState
import com.venkoi.cuentame.feature.purchases.viewmodel.PurchaseDraftViewModel
        ...
        AlertDialog(
            ...
            text = {
                Column {
                    Text(
                        when (duplicate.type) {
                            com.venkoi.cuentame.core.model.purchase.DuplicateInvoiceType.SAME_DOCUMENT ->
                                stringResource(R.string.ocr_duplicate_same_document)
                            com.venkoi.cuentame.core.model.purchase.DuplicateInvoiceType.SAME_SUPPLIER_INVOICE_NUMBER ->
