...
class BackupManifestContractTest {
    ...
    fun representativeSnapshot_schema2_consistent() {
        val snapshot = BackupTestFixtures.createEmptySnapshotDto().copy(
            restaurants = listOf(com.venkoi.restaurantops.core.backup.model.RestaurantBackupDto("r1", "Rest", "USD", "en-US", 0, 0, null)),
            inventoryAreas = listOf(com.venkoi.restaurantops.core.backup.model.InventoryAreaBackupDto("a1", "r1", "Area", "area", 0, true, 0, 0, null)),
            units = listOf(com.venkoi.restaurantops.core.backup.model.UnitBackupDto("u1", "U", "u", "MASS", "1", true, 0)),
            ingredients = listOf(com.venkoi.restaurantops.core.backup.model.IngredientBackupDto("i1", "r1", "I", "i", null, "u1", "a1", null, null, null, true, 0, 0, null)),
            ingredientUnitOptions = listOf(com.venkoi.restaurantops.core.backup.model.IngredientUnitOptionBackupDto("o1", "i1", "O", "o", null, "1", true, true, true, true, 0, 0, null))
        )
    ...
    fun representativeSnapshot_schema3_consistent() {
        val snapshot = BackupTestFixtures.createEmptySnapshotDto().copy(
            restaurants = listOf(com.venkoi.restaurantops.core.backup.model.RestaurantBackupDto("r1", "Rest", "USD", "en-US", 0, 0, null)),
            preparationRecipes = listOf(com.venkoi.restaurantops.core.backup.model.PreparationRecipeBackupDto("rec1", "r1", "i1", "R", "r", "1", "1", "o1", "ACTIVE", null, 0, 0, null)),
            preparationRecipeComponents = listOf(com.venkoi.restaurantops.core.backup.model.PreparationRecipeComponentBackupDto("rc1", "rec1", "i2", "o2", "1", "1", 0, null, 0, 0))
        )
