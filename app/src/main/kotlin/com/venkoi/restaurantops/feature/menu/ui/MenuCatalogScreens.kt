...
import com.venkoi.restaurantops.core.model.menu.*
import com.venkoi.restaurantops.feature.menu.viewmodel.*
import com.venkoi.restaurantops.core.common.util.ShareHelper

@OptIn(ExperimentalMaterial3Api::class)
@Composable fun MenuCatalogListRoute(onBack:()->Unit,onOpen:(com.venkoi.restaurantops.core.common.ids.MenuId)->Unit,vm:MenuCatalogListViewModel=hiltViewModel()){
...
@OptIn(ExperimentalMaterial3Api::class)
@Composable fun MenuCatalogDetailRoute(onBack:()->Unit,onOpenMenuItem:(MenuRecipeId)->Unit,onCreateMenuItem:(com.venkoi.restaurantops.core.common.ids.MenuId,com.venkoi.restaurantops.core.common.ids.MenuCategoryId)->Unit,vm:MenuCatalogDetailViewModel=hiltViewModel()){
 ...
 val context=LocalContext.current;var pendingExport by remember{mutableStateOf<com.venkoi.restaurantops.core.domain.service.MenuPackageExport?>(null)}
