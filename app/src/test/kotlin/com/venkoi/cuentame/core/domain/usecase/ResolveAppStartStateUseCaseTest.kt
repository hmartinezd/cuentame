...
class ResolveAppStartStateUseCaseTest {
    ...
    private var restaurantValue: com.venkoi.cuentame.core.model.restaurant.Restaurant? = null
    ...
    private val fakeRestaurantRepository = object : RestaurantRepository {
        override fun observeRestaurant(): Flow<com.venkoi.cuentame.core.model.restaurant.Restaurant?> = MutableStateFlow(restaurantValue)
        override suspend fun getRestaurant(): com.venkoi.cuentame.core.model.restaurant.Restaurant? = restaurantValue
    ...
    fun `both complete returns Ready`() = runTest {
        ...
        restaurantValue = com.venkoi.cuentame.core.model.restaurant.Restaurant(
            id = com.venkoi.cuentame.core.common.ids.RestaurantId("id"),
            name = "Test",
            currencyCode = "USD",
            localeTag = "en-US",
