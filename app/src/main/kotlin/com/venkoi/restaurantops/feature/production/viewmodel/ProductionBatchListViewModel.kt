        ...
        viewModelScope.launch {
            retryTrigger.collectLatest {
                ...
                try {
                    ...
                    if (restaurant == null) {
                        _uiState.update { it.copy(screenState = ProductionBatchScreenState.LoadError(com.venkoi.restaurantops.core.presentation.ui.UiMessage.Resource(com.venkoi.restaurantops.R.string.error_no_restaurant))) }
                    ...
                    _uiState.update {
                        it.copy(
                            screenState = ProductionBatchScreenState.LoadError(com.venkoi.restaurantops.core.presentation.ui.UiMessage.Resource(com.venkoi.restaurantops.R.string.error_generic))
                        )
                    }
                }
            }
