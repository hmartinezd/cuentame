...
import com.venkoi.restaurantops.core.domain.service.PreparationCostCalculator
...
class RoomPreparationCostRepositoryTest {
    ...
    @Test fun malformedProjectionIsInvalidWhileZeroIsAvailable() = runBlocking {
        ...
        repository.observeRecipeCost(PreparationRecipeId("recipe")).test {
            ...
            assertThat(invalid.components.single().missingReason)
                .isEqualTo(com.venkoi.restaurantops.core.model.ingredient.PreparationCostMissingReason.INGREDIENT_COST_INVALID)
            ...
            assertThat(zero.status).isEqualTo(com.venkoi.restaurantops.core.model.ingredient.PreparationCostStatus.FULLY_COSTED)
    ...
    @Test fun missingProjectionStillUsesKnownVendorPriceImpact() = runBlocking {
        ...
        repository.observeRecipeCost(PreparationRecipeId("recipe")).test {
            val cost = awaitNonNull()
            assertThat(cost.status).isEqualTo(com.venkoi.restaurantops.core.model.ingredient.PreparationCostStatus.UNCOSTED)
            assertThat(cost.totalBatchCost).isNull()
            assertThat(cost.components.single().missingReason)
                .isEqualTo(com.venkoi.restaurantops.core.model.ingredient.PreparationCostMissingReason.INGREDIENT_COST_MISSING)
    ...
    private suspend fun app.cash.turbine.ReceiveTurbine<com.venkoi.restaurantops.core.model.ingredient.PreparationRecipeCost?>.awaitNonNull(): com.venkoi.restaurantops.core.model.ingredient.PreparationRecipeCost {
