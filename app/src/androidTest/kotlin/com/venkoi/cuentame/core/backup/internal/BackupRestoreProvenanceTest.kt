...
class BackupRestoreProvenanceTest {
    ...
    fun application_and_origin_records_survive_backup_restore() = runBlocking {
        ...
        val manifest = BackupManifest(
            ...
            currencyCode = "USD",
            tableMetadata = mapOf(
                "restaurants" to com.venkoi.cuentame.core.model.backup.TableMetadata(1, false),
                "inventory_areas" to com.venkoi.cuentame.core.model.backup.TableMetadata(1, false),
                "units" to com.venkoi.cuentame.core.model.backup.TableMetadata(1, false),
                "ingredients" to com.venkoi.cuentame.core.model.backup.TableMetadata(1, false),
                "ingredient_unit_options" to com.venkoi.cuentame.core.model.backup.TableMetadata(1, false),
                "purchase_receipts" to com.venkoi.cuentame.core.model.backup.TableMetadata(1, false),
                "purchase_lines" to com.venkoi.cuentame.core.model.backup.TableMetadata(1, false),
                "purchase_invoice_ocr_results" to com.venkoi.cuentame.core.model.backup.TableMetadata(1, false),
                "purchase_invoice_parse_results" to com.venkoi.cuentame.core.model.backup.TableMetadata(1, false),
                "purchase_invoice_draft_applications" to com.venkoi.cuentame.core.model.backup.TableMetadata(1, false),
                "purchase_invoice_line_origins" to com.venkoi.cuentame.core.model.backup.TableMetadata(1, false)
            ),
