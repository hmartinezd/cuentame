...
class IngredientUiTest {
    ...
    fun setup() {
        ...
        runBlocking {
            ...
            database.unitDao().insertSeedUnits(com.venkoi.restaurantops.core.database.seed.UnitSeeds.ALL_UNITS)
            // Seed a restaurant as well
            database.restaurantDao().insert(com.venkoi.restaurantops.core.model.restaurant.Restaurant(
                com.venkoi.restaurantops.core.common.ids.RestaurantId("rest_ing_test"), "Test Ing Rest", "USD", "en-US", java.time.Instant.now(), java.time.Instant.now(), null
            ).toEntity())
            database.inventoryAreaDao().upsert(com.venkoi.restaurantops.core.model.inventory.InventoryArea(
                com.venkoi.restaurantops.core.common.ids.InventoryAreaId("area_ing_test"), com.venkoi.restaurantops.core.common.ids.RestaurantId("rest_ing_test"), "Area 1", "area 1", 0, true, java.time.Instant.now(), java.time.Instant.now(), null
            ).toEntity())
