...
import com.venkoi.cuentame.feature.settings.viewmodel.RestaurantSettingsViewModel
...
fun RestaurantProfileScreen(
    ...
    Scaffold(
        topBar = {
            TopAppBar(
                title = { Text(stringResource(R.string.settings_restaurant)) },
                navigationIcon = {
        ...
        Column(modifier = Modifier.fillMaxSize().padding(padding).verticalScroll(rememberScrollState()).padding(horizontal = 16.dp).adaptiveContentWidth(760.dp).padding(vertical = 16.dp)) {
            OutlinedTextField(
                value = editName,
