...
private object EmptyPreparationCostRepository : PreparationCostRepository {
    ...
    override fun observeRecipeCostSummaries(restaurantId: com.venkoi.restaurantops.core.common.ids.RestaurantId) = flowOf(emptyList<com.venkoi.restaurantops.core.model.ingredient.PreparationRecipeCostSummary>())
}
