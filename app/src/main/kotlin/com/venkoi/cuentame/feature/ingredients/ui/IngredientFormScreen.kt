...
import com.venkoi.cuentame.feature.ingredients.viewmodel.IngredientFormEvent
import com.venkoi.cuentame.feature.ingredients.viewmodel.IngredientFormViewModel
...
fun IngredientFormScreen(
    ...
    onDefaultAreaSelected: (com.venkoi.cuentame.core.common.ids.InventoryAreaId?) -> Unit,
    ...
    onSave: () -> Unit,
    getStandardPreview: (UnitOfMeasure) -> com.venkoi.cuentame.feature.ingredients.model.UnitConversionChoiceUiModel?,
    onBack: () -> Unit
) {
...
private fun DefaultAreaSelector(
    areas: List<InventoryArea>,
    selected: com.venkoi.cuentame.core.common.ids.InventoryAreaId?,
    onSelected: (com.venkoi.cuentame.core.common.ids.InventoryAreaId?) -> Unit
) {
