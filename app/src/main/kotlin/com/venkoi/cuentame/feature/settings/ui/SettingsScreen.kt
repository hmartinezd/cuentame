package com.venkoi.cuentame.feature.settings.ui
...
import com.venkoi.cuentame.feature.settings.presentation.toUserMessageRes
import androidx.compose.material.icons.filled.Restore
import com.venkoi.cuentame.core.model.locale.SupportedAppLocale
import com.venkoi.cuentame.feature.settings.viewmodel.BackupRestoreUiState
import com.venkoi.cuentame.feature.settings.viewmodel.BackupRestoreViewModel
...
import com.venkoi.cuentame.core.backup.api.BackupRestoreProgress
import com.venkoi.cuentame.core.model.backup.BackupRestoreEligibility
import com.venkoi.cuentame.feature.settings.viewmodel.BackupOperationId
import com.venkoi.cuentame.feature.settings.viewmodel.BackupUiEvent
import com.venkoi.cuentame.feature.settings.viewmodel.BackupUiState
import com.venkoi.cuentame.feature.settings.viewmodel.BackupViewModel
import com.venkoi.cuentame.feature.settings.viewmodel.SettingsViewModel
        ...
        backupViewModel.events.collect { event ->
            when (event) {
                ...
                is BackupUiEvent.ShareDiagnosticReport -> {
                    com.venkoi.cuentame.core.common.util.ShareHelper.shareTextFile(
                        context = context,
...
fun SettingsScreen(
    ...
    isSaving: Boolean,
    backupUiState: BackupUiState,
    autoBackupStatus: com.venkoi.cuentame.feature.settings.viewmodel.AutoBackupUiStatus,
    ...
    when (val state = restoreUiState) {
        ...
        BackupRestoreUiState.RecoveryRequired -> {
            RestoreErrorDialog(
                failure = com.venkoi.cuentame.core.model.backup.BackupRestoreFailure.RecoveryRequired,
                onDismiss = {},
...
fun RestorePreviewDialog(
    preview: com.venkoi.cuentame.core.model.backup.BackupRestorePreview,
...
fun RestoreSuccessDialog(
    summary: com.venkoi.cuentame.feature.settings.viewmodel.BackupRestoreSuccessSummary,
    onDismiss: () -> Unit
) {
    AlertDialog(
        onDismissRequest = onDismiss,
...
fun RestoreErrorDialog(
    failure: com.venkoi.cuentame.core.model.backup.BackupRestoreFailure,
    onDismiss: () -> Unit,
    onRetry: (() -> Unit)?,
