...
import com.venkoi.cuentame.feature.purchases.viewmodel.RawOcrViewerUiState
import com.venkoi.cuentame.feature.purchases.viewmodel.RawOcrViewerViewModel
...
@Composable
private fun OcrHeader(result: com.venkoi.cuentame.core.model.purchase.ocr.PurchaseInvoiceOcrResult) {
    Card(
