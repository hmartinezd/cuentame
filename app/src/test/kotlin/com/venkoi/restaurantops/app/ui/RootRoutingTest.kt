...
class RootRoutingTest {
    ...
    @Test fun `local setup never routes legacy onboarding`() { assertRoute(SaaSStartupState.RequiresLocalSetup(USER, ACCESS), AppStartState.RequiresOnboarding, RootDestination.SETUP_REQUIRED) }
