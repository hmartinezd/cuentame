...
class ProductionFailureBoundaryTest {
    ...
    private suspend fun testPostFailure(point: String) {
        ...
        assertThat(snapshotBefore.batch.status).isEqualTo(com.venkoi.cuentame.core.model.inventory.DocumentStatus.DRAFT)
        ...
        assertThat(snapshotAfter.batch.status).isEqualTo(com.venkoi.cuentame.core.model.inventory.DocumentStatus.DRAFT)
    ...
    private suspend fun testVoidFailure(point: String) {
        ...
        val snapshotBefore = captureProductionSnapshot(batchId)
        assertThat(snapshotBefore.batch.status).isEqualTo(com.venkoi.cuentame.core.model.inventory.DocumentStatus.POSTED)
        ...
        assertThat(snapshotAfter.batch.status).isEqualTo(com.venkoi.cuentame.core.model.inventory.DocumentStatus.POSTED)
    ...
    private data class ProductionSnapshot(
        val batch: com.venkoi.cuentame.core.model.inventory.ProductionBatch,
        val components: List<com.venkoi.cuentame.core.model.inventory.ProductionBatchComponent>,
        val movements: List<com.venkoi.cuentame.core.database.entity.InventoryMovementEntity>,
        val compBalance: com.venkoi.cuentame.core.database.entity.InventoryBalanceProjectionEntity?,
        val compCost: com.venkoi.cuentame.core.database.entity.IngredientCostProjectionEntity?,
        val outBalance: com.venkoi.cuentame.core.database.entity.InventoryBalanceProjectionEntity?,
        val outCost: com.venkoi.cuentame.core.database.entity.IngredientCostProjectionEntity?
    )
